...
!function(a) {
    ...
    $.extend($.jgrid, {
        ...
        parseDate: function(a, b, c, d) {
            ...
            b && null != b)
                ...
                o = new Date(n.y,n.m,n.d,n.h,n.i,n.s,n.u);
            if (d.userLocalTime && 0 === q && (q -= (new Date).getTimezoneOffset(),
            q > 0 && o.setTime(Number(Number(o) + 60 * q * 1e3))),
            void 0 === c)
                return o;
            ...
            var $t = this
              , QueryObject = function(d, q) {
                ...
                this._compare = function(a, b, c) {
                    ...
                    void 0 === a && (a = null),
                    void 0 === b && (b = null),
                    null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? b > a ? -c : a > b ? c : 0 : (_usecase || "number" == typeof a || "number" == typeof b || (a = String(a),
                    b = String(b)),
                    b > a ? -c : a > b ? c : 0)
                }
                ,
        ...
        return this.each(function() {
            if (!this.grid) {
                  ...
                  , e = {
                    ...
                    dragMove: function(a) {
                        if (this.resizing) {
                            ...
                            c.forceFit === !0 ? (b = this.headers[this.resizing.idx + c.nv],
                            d = "ltr" === c.direction ? b.width - e : b.width + e,
                            d > c.minColWidth && (f.newWidth = g,
                            b.newWidth = d)) : (this.newWidth = "ltr" === c.direction ? c.tblwidth + e : c.tblwidth - e,
                            f.newWidth = g))
                        }
                    },
                    dragEnd: function(a) {
                        ...
                        this.resizing) {
                            ...
                            c.forceFit === !0 ? (e = this.headers[b + c.nv].newWidth || this.headers[b + c.nv].width,
                            this.headers[b + c.nv].width = e,
                            this.headers[b + c.nv].el.style.width = e + "px",
                            this.cols[b + c.nv].style.width = e + "px",
                            this.footers.length > 0 && (this.footers[b + c.nv].style.width = e + "px"),
                            c.colModel[b + c.nv].width = e) : (c.tblwidth = this.newWidth || c.tblwidth,
                            $("table:first", this.bDiv).css("width", c.tblwidth + "px"),
                            $("table:first", this.hDiv).css("width", c.tblwidth + "px"),
                            this.hDiv.scrollLeft = this.bDiv.scrollLeft,
                            c.footerrow && ($("table:first", this.sDiv).css("width", c.tblwidth + "px"),
                            this.sDiv.scrollLeft = this.bDiv.scrollLeft)),
                            a && ($(d).triggerHandler("jqGridResizeStop", [e, b]),
                            $.isFunction(c.resizeStop) && c.resizeStop.call(d, e, b))
                        }
                        this.curGbox = null,
                        document.onselectstart = function() {
                            return !0
                    ...
                    populateVisible: function() {
                        ...
                        if (a) {
                            ...
                            if (f) {
                                ...
                                if (a > o && 0 >= n && (void 0 === c.lastpage || (parseInt((o + m + p - 1) / p, 10) || 0) <= c.lastpage) && (j = parseInt((a - o + p - 1) / p, 10) || 1,
                                o >= 0 || 2 > j || c.scroll === !0 ? (i = (Math.round((o + m) / p) || 0) + 1,
                                n = -1) : n = 1),
                                n > 0 && (i = (parseInt(m / p, 10) || 0) + 1,
                                j = (parseInt((m + a) / p, 10) || 0) + 2 - i,
                                k = !0),
                                j) {
                                    if (c.lastpage && (i > c.lastpage || 1 === c.lastpage || i === c.page && i === c.lastpage))
                                        return;
                                    e.hDiv.loading ? e.timer = setTimeout(e.populateVisible, c.scrollTimeout) : (c.page = i,
                                    k && (e.selectionPreserver(g[0]),
                                    e.emptyRows.call(g[0], !1, !1)),
                                    e.populate(j)),
                ...
                for (g in $.jgrid.regional)
                    $.jgrid.regional.hasOwnProperty(g) && (0 === i && (f = g),
                    i++);
                if (1 === i && f !== c.regional && (c.regional = f),
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function(a, b) {
                    ...
                    0 === b ? m += "width: " + e.headers[a].width + "px;" : ($.isFunction(k.cellattr) || "string" == typeof k.cellattr && null != $.jgrid.cellattr && $.isFunction($.jgrid.cellattr[k.cellattr])) && (i = $.isFunction(k.cellattr) ? k.cellattr : $.jgrid.cellattr[k.cellattr],
                    j = i.call(d, g, c, f, k, h),
                    j && "string" == typeof j && (j = j.replace(/style/i, "style").replace(/title/i, "title"),
                    j.indexOf("title") > -1 && (k.title = !1),
                    j.indexOf("class") > -1 && (n = void 0),
                    p = j.replace(/\-style/g, "-sti").split(/style/),
                    2 === p.length ? (p[1] = $.trim(p[1].replace(/\-sti/g, "-style").replace("=", "")),
                    ...
                    for (c = 0; c < d.p.colModel.length; c++)
                        b = d.p.colModel[c],
                        "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name,
                        d.p.keyName !== !1 && b.key === !0 && (d.p.keyName = e[f]),
                        f++);
                    return e
                }, G = function(a) {
                    ...
                    b === !0 && this.p.treeGrid && !this.p.loadonce && (this.p.data = [],
                    this.p._index = {})
                }, I = function() {
                    ...
                    if ("local" === m.datatype && p.repeatitems === !0)
                        for (j = G(s),
                        k = F("local"),
                        e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex,
                        a = 0; o > a; a++) {
                            for (c = n[a],
                            f = $.jgrid.getAccessor(c, e),
                            void 0 === f && ("number" == typeof e && null != q[e + s] && (f = $.jgrid.getAccessor(c, q[e + s].name)),
                            void 0 === f && (f = t + a,
                            r && (g = $.jgrid.getAccessor(c, r) || c,
                            f = null != g && void 0 !== g[e] ? g[e] : f,
                            g = null))),
                            i = {},
                            i[p.id] = f,
                    ...
                    for (a = d.p.keyName === !1 || d.p.loadonce === !0 ? d.p.localReader.id : d.p.keyName,
                    d.p._index = [],
                    b = 0; e > b; b++)
                        c = $.jgrid.getAccessor(d.p.data[b], a),
                        void 0 === c && (c = String(b + 1)),
                        d.p._index[c] = b
                }, K = function(a, b, c, e, f) {
                    var g, h = "-1", i = "", j = b ? "display:none;" : "", k = $(d).triggerHandler("jqGridRowAttr", [e, f, a]);
                    if ("object" != typeof k && (k = $.isFunction(d.p.rowattr) ? d.p.rowattr.call(d, e, f, a) : "string" == typeof d.p.rowattr && null != $.jgrid.rowattr && $.isFunction($.jgrid.rowattr[d.p.rowattr]) ? $.jgrid.rowattr[d.p.rowattr].call(d, e, f, a) : {}),
                    !$.isEmptyObject(k)) {
                    ...
                    if (g && (d.p.data = [],
                    d.p._index = {},
                    d.p.localReader.id = h),
                    d.p.reccount = 0,
                    $.isXMLDoc(a)) {
                        -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (H.call(d, !1, !0),
                        b = 1);
                        ...
                        d.p.subGrid === !0 && (A = 1,
                        p = $.jgrid.getMethod("addSubGridCell")),
                        i.repeatitems || (I = F(j)),
                        q = d.p.keyName === !1 ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName,
                        r = -1 === String(q).indexOf("[") ? I.length ? function(a, b) {
                            return $(q, a).text() || b
                        }
                        : function(a, b) {
                        ...
                        O || (O = []);
                        var P, Q = O.length, R = 0, S = [], T = parseInt(d.p.rowNum, 10), U = d.p.scroll ? $.jgrid.randId() : 1;
                        if (Q > 0 && d.p.page <= 0 && (d.p.page = 1),
                        O && Q) {
                            e && (T *= e + 1);
                            var V, W = $.isFunction(d.p.afterInsertRow), X = !1, Y = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"), Z = B ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", _ = z ? k(l, "multiBox", !1, "cbox") : "";
                            for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0,
                            V = $.jgrid.getMethod("groupingPrepare")); Q > R; ) {
                                t = O[R],
                                u = r(t, U + R),
                                u = d.p.idPrefix + u,
                                P = 0 === b ? 0 : b + 1,
                                ...
                                var ab = L.length;
                                if (L.push(""),
                                B && L.push(E(0, R, d.p.page, d.p.rowNum, Z)),
                                z && L.push(D(u, B, R, !1, _)),
                                A && L.push(p.call(w, z + B, R + b)),
                                i.repeatitems) {
                                    s || (s = G(z + A + B));
                                    var bb = $.jgrid.getXmlData(t, i.cell, !0);
                                    $.each(s, function(a) {
                                        var c = bb[this];
                                        return c ? (o = c.textContent || c.text,
                                        J[d.p.colModel[a + z + A + B].name] = o,
                                        void L.push(C(u, o, a + z + A + B, R + b, t, J))) : !1
                                    })
                                } else
                                    for (m = 0; m < I.length; m++)
                                        o = $.jgrid.getXmlData(t, I[m]),
                                        J[d.p.colModel[m + z + A + B].name] = o,
                                        L.push(C(u, o, m + z + A + B, R + b, t, J));
                                if (L[ab] = K(u, X, v, J, t),
                                L.push("</tr>"),
                                d.p.grouping && (S.push(L),
                                d.p.groupingView._locgr || V.call(w, J, R),
                                L = []),
                                (g || d.p.treeGrid === !0 && !d.p._ald) && (J[h] = $.jgrid.stripPref(d.p.idPrefix, u),
                                d.p.data.push(J),
                                d.p._index[J[h]] = d.p.data.length - 1),
                                d.p.gridview === !1 && (Y.append(L.join("")),
                                w.triggerHandler("jqGridAfterInsertRow", [u, J, t]),
                                W && d.p.afterInsertRow.call(d, u, J, t),
                                L = []),
                                J = {},
                                x++,
                                R++,
                        ...
                        if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0,
                        d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T),
                        S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(L.join("")) : (Y.append(L.join("")),
                        d.grid.cols = d.rows[0].cells)),
                        d.p.subGrid === !0)
                            try {
                                w.jqGrid("addSubGrid", z + B)
                            } catch (cb) {}
                        if (d.p.totaltime = new Date - f,
                        x > 0 && 0 === d.p.records && (d.p.records = Q),
                        L = null,
                        d.p.treeGrid === !0)
                            try {
                        ...
                        if (d.p.reccount = x,
                        d.p.treeANode = -1,
                        d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0),
                        g && (d.p.records = Q,
                        d.p.lastpage = Math.ceil(Q / T)),
                        c || d.updatepager(!1, !0),
                        g) {
                            for (; Q > x; ) {
                                if (t = O[x],
                                ...
                                i.repeatitems) {
                                    ...
                                    $.each(s, function(a) {
                                        var b = eb[this];
                                        return b ? (o = b.textContent || b.text,
                                        void (J[d.p.colModel[a + z + A + B].name] = o)) : !1
                                    })
                                } else
                                    for (m = 0; m < I.length; m++)
                                        o = $.jgrid.getXmlData(t, I[m]),
                            ...
                            w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T),
                            S = null)
                        }
                    }
                }, M = function(a, b, c, e) {
                    ...
                    if (a) {
                        ...
                        d.p.reccount = 0,
                        "local" === d.p.datatype ? (g = d.p.localReader,
                        h = "local") : (g = d.p.jsonReader,
                        h = "json");
                        ...
                        for (d.p.grouping && (ab = d.p.groupingView.groupCollapse === !0,
                        Y = $.jgrid.getMethod("groupingPrepare")); t > o; ) {
                            if (q = u[o],
                            x = $.jgrid.getAccessor(q, v),
                            void 0 === x && ("number" == typeof v && null != d.p.colModel[v + J + L + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + L + M].name)),
                            void 0 === x && (x = W + o,
                            0 === I.length && g.cell))) {
                            ...
                            var fb = Q.length;
                            for (Q.push(""),
                            M && Q.push(E(0, o, d.p.page, d.p.rowNum, cb)),
                            J && Q.push(D(x, M, o, U, db)),
                            L && Q.push(r.call(A, J + M, o + b)),
                            s = O,
                            g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q),
                            $.isArray(q) && (s = N)),
                            p = 0; p < s.length; p++)
                                m = $.jgrid.getAccessor(q, s[p]),
                                P[d.p.colModel[p + J + L + M].name] = m,
                                Q.push(C(x, m, p + J + L + M, o + b, q, P));
                            if (z += U ? " " + n : "",
                            Q[fb] = K(x, ab, z, P, q),
                            Q.push("</tr>"),
                            d.p.grouping && (_.push(Q),
                            d.p.groupingView._locgr || Y.call(A, P, o),
                            Q = []),
                            (j || d.p.treeGrid === !0 && !d.p._ald) && (P[i] = $.jgrid.stripPref(d.p.idPrefix, x),
                            d.p.data.push(P),
                            d.p._index[P[i]] = d.p.data.length - 1),
                            d.p.gridview === !1 && (bb.append(Q.join("")),
                            A.triggerHandler("jqGridAfterInsertRow", [x, P, q]),
                            Z && d.p.afterInsertRow.call(d, x, P, q),
                            Q = []),
                            P = {},
                            B++,
                            o++,
                        ...
                        if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0,
                        d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V),
                        _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (bb.append(Q.join("")),
                        d.grid.cols = d.rows[0].cells)),
                        d.p.subGrid === !0)
                            try {
                        ...
                        if (d.p.totaltime = new Date - f,
                        B > 0 && 0 === d.p.records && (d.p.records = t),
                        Q = null,
                        d.p.treeGrid === !0)
                            try {
                        ...
                        if (d.p.reccount = B,
                        d.p.treeANode = -1,
                        d.p.userDataOnFooter && A.jqGrid("footerData", "set", d.p.userData, !0),
                        j && (d.p.records = t,
                        d.p.lastpage = Math.ceil(t / V)),
                        c || d.updatepager(!1, !0),
                        j) {
                            for (; t > B && u[B]; ) {
                                if (q = u[B],
                                ...
                                if (q) {
                                    for (x = d.p.idPrefix + x,
                                    s = O,
                                    g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q),
                                    $.isArray(q) && (s = N)),
                                    p = 0; p < s.length; p++)
                                        P[d.p.colModel[p + J + L + M].name] = $.jgrid.getAccessor(q, s[p]);
                            ...
                            d.p.grouping && (d.p.groupingView._locgr = !0,
                            A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V),
                            _ = null)
                        }
                    }
                }, N = function() {
                    function a(b) {
                        var c, e, f, g, h, i, k = 0;
                        if (null != b.groups) {
                            for (e = b.groups.length && "OR" === b.groupOp.toString().toUpperCase(),
                            e && q.orBegin(),
                            c = 0; c < b.groups.length; c++) {
                                k > 0 && e && q.or();
                                try {
                                    a(b.groups[c])
                                } catch (l) {
                        ...
                        if (null != b.rules)
                            try {
                                for (f = b.rules.length && "OR" === b.groupOp.toString().toUpperCase(),
                                f && q.orBegin(),
                                c = 0; c < b.rules.length; c++)
                                    h = b.rules[c],
                                    g = b.groupOp.toString().toUpperCase(),
                                    p[h.op] && h.field && (k > 0 && g && "OR" === g && (q = q.or()),
                                    i = j[h.field],
                                    "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(d, i.newfmt, h.data, i.srcfmt)),
                                    q = p[h.op](q, g)(h.field, h.data, j[h.field])),
                                    k++;
                                f && q.orEnd()
                            } catch (m) {
                                alert(m)
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        if ($.each(d.p.colModel, function() {
                            if (c = this.sorttype || "text",
                            "date" === c || "datetime" === c ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (b = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat"),
                            e = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")) : b = e = this.datefmt || "Y-m-d",
                            j[this.name] = {
                                stype: c,
                                srcfmt: b,
                                newfmt: e,
                            ...
                            d.p.multiSort || i || this.index !== d.p.sortname && this.name !== d.p.sortname || (g = this.name,
                            i = !0)
                        }),
                        d.p.multiSort && (g = s,
                        h = t),
                        d.p.treeGrid && d.p._sort)
                            return void $(d).jqGrid("SortTree", g, d.p.sortorder, j[g].stype || "text", j[g].srcfmt || "");
                        var p = {
                            eq: function(a) {
                                return a.equals
                            },
                        ...
                        if (d.p.ignoreCase && (q = q.ignoreCase()),
                        d.p.search === !0) {
                            var r = d.p.postData.filters;
                            if (r)
                                "string" == typeof r && (r = $.jgrid.parse(r)),
                                a(r);
                            else
                                try {
                            ...
                            d.p.treeGrid && "nested" === d.p.treeGridModel && q.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null);
                        if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (m = 0,
                        g = null),
                        d.p.grouping)
                            for (n = 0; m > n; n++)
                                q.orderBy(l[n], o.groupOrder[n], k[n].stype, k[n].srcfmt);
                        ...
                        if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                            ...
                            for (B = 0; x > B; B++) {
                                if (D)
                                    for (C in d.p.userData)
                                        d.p.userData.hasOwnProperty(C) && (d.p.userData[C] += parseFloat(v[B][C] || 0));
                                E.call($(d), v[B], B, w)
                            }
                        }
                    ...
                    if (p = d.p.pager || "",
                    p += d.p.toppager ? p ? "," + d.p.toppager : d.p.toppager : "") {
                        if (j = $.jgrid.getRegional(d, "formatter.integer"),
                        c = y(d.p.page),
                        e = y(d.p.lastpage),
                        $(".selbox", p)[this.p.useProp ? "prop" : "attr"]("disabled", !1),
                        d.p.pginput === !0 && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")),
                        d.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")),
                        $(".ui-pg-input", p).val(d.p.page),
                        n = d.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r,
                        $(n).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)),
                        d.p.viewrecords)
                            if (0 === d.p.reccount)
                        ...
                        d.p.pgbuttons === !0 && (0 >= c && (c = e = 0),
                        1 === c || 0 === c ? ($("#first" + r + ", #prev" + r).addClass(m).removeClass(o),
                        d.p.toppager && $("#first_t" + s + ", #prev_t" + s).addClass(m).removeClass(o)) : ($("#first" + r + ", #prev" + r).removeClass(m),
                        d.p.toppager && $("#first_t" + s + ", #prev_t" + s).removeClass(m)),
                        c === e || 0 === c ? ($("#next" + r + ", #last" + r).addClass(m).removeClass(o),
                        d.p.toppager && $("#next_t" + s + ", #last_t" + s).addClass(m).removeClass(o)) : ($("#next" + r + ", #last" + r).removeClass(m),
                        d.p.toppager && $("#next_t" + s + ", #last_t" + s).removeClass(m)))
                    }
                    ...
                    if (!d.grid.hDiv.loading) {
                        ...
                        : null !== g.npage && delete d.p.postData[g.npage],
                        d.p.grouping) {
                        ...
                        if ($.isFunction(d.p.datatype))
                            return void d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j);
                        if ($.isFunction(d.p.beforeRequest) && (p = d.p.beforeRequest.call(d),
                        void 0 === p && (p = !0),
                        p === !1))
                            return;
                        ...
                        case "script":
                            $.ajax($.extend({
                                ...
                                success: function(c, f, g) {
                                    return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void Q() : ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j),
                                    $(d).triggerHandler("jqGridLoadComplete", [c]),
                                    i && i.call(d, c),
                                    $(d).triggerHandler("jqGridAfterLoadComplete", [c]),
                                    e && d.grid.populateVisible(),
                                    (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"),
                                    c = null,
                                    void (1 === a && Q()))
                                },
                    ...
                    f = a + "_center",
                    g = a + "_right",
                    $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table class='ui-pg-table ui-common-table ui-pager-table'><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"),
                    d.p.rowList.length > 0) {
                        t = '<td dir="' + h + '">',
                        ...
                        for (n = 0; n < d.p.rowList.length; n++)
                            v = d.p.rowList[n].toString().split(":"),
                            1 === v.length && (v[1] = v[0]),
                            t += '<option role="option" value="' + v[0] + '"' + (y(d.p.rowNum, 0) === y(v[0], 0) ? ' selected="selected"' : "") + ">" + v[1] + "</option>";
                        t += "</select></td>"
                    }
                    if ("rtl" === h && (s += t),
                    d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"),
                    d.p.pgbuttons === !0) {
                    ...
                    $("#testpg").remove(),
                    i > 0 && ("" !== r && (i += 50),
                    $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)),
                    d.p._nvtd = [],
                    d.p._nvtd[0] = Math.floor(i ? (d.p.width - i) / 2 : d.p.width / 3),
                    d.p._nvtd[1] = 0,
                    s = null,
                    $(".ui-pg-selbox", "#" + c).bind("change", function() {
                        return u("records", this) ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1,
                        d.p.rowNum = this.value,
                        d.p.pager && $(".ui-pg-selbox", d.p.pager).val(this.value),
                        d.p.toppager && $(".ui-pg-selbox", d.p.toppager).val(this.value),
                        R(),
                        !1) : !1
                    }),
                    d.p.pgbuttons === !0 && ($(".ui-pg-button", "#" + c).hover(function() {
                        $(this).hasClass(m) ? this.style.cursor = "default" : ($(this).addClass(o),
                        this.style.cursor = "pointer")
                    }, function() {
                        $(this).hasClass(m) || ($(this).removeClass(o),
                    ...
                    $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b)).click(function() {
                        ...
                        i = !1,
                        a = c - 1),
                        u(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1,
                        e = !0),
                        this.id === "prev" + b && g && (d.p.page = a - 1,
                        e = !0),
                        this.id === "next" + b && h && (d.p.page = a + 1,
                        e = !0),
                        this.id === "last" + b && i && (d.p.page = c,
                        e = !0),
                        e && R(),
                        !1) : !1
                    })),
                    d.p.pginput === !0 && $("#" + c).on("keypress", "input.ui-pg-input", function(a) {
                        ...
                        return 13 === b ? u("user", this) ? ($(this).val(y($(this).val(), 1)),
                        d.p.page = $(this).val() > 0 ? $(this).val() : d.p.page,
                        R(),
                        !1) : !1 : this
                    })
                }, U = function(a, b) {
                    ...
                    e[a].lso ? "asc" === e[a].lso ? (e[a].lso += "-desc",
                    g = "desc") : "desc" === e[a].lso ? (e[a].lso += "-asc",
                    g = "asc") : ("asc-desc" === e[a].lso || "desc-asc" === e[a].lso) && (e[a].lso = "") : e[a].lso = g = e[a].firstsortorder || "asc",
                    g ? ($("span.s-ico", f).show(),
                    $("span.ui-icon-" + g, f).removeClass(m),
                    $(f).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", f).hide();
                    var h = s.indexOf(c);
                    -1 === h ? (s.push(c),
                    t.push(g)) : g ? t[h] = g : (t.splice(h, 1),
                    s.splice(h, 1)),
                    d.p.sortorder = "",
                    d.p.sortname = "";
                    for (var i = 0, j = s.length; j > i; i++)
                        i > 0 && (d.p.sortname += ", "),
                        d.p.sortname += s[i],
                    ...
                    if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                        if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc",
                        d.p.page = 1),
                        d.p.multiSort)
                            U(b, f);
                        else {
                            ...
                            d.p.frozenColumns && (g = d.grid.fhDiv.find("span.ui-grid-ico-sort"),
                            g.addClass(m),
                            j && g.css("display", "none"),
                            ...
                            d.p.viewsortcols[0] || (d.p.lastsort !== b ? (d.p.frozenColumns && d.grid.fhDiv.find("span.s-ico").hide(),
                            $("span.s-ico", h).hide(),
                            $("span.s-ico", i).show()) : "" === d.p.sortname && $("span.s-ico", i).show()),
                        ...
                        if ($.isFunction(d.p.onSortCol) && "stop" === d.p.onSortCol.call(d, d.p.sortname, b, d.p.sortorder))
                            return void (d.p.lastsort = b);
                        if ("local" === d.p.datatype ? d.p.deselectAfterSort && $(d).jqGrid("resetSelection") : (d.p.selrow = null,
                        d.p.multiselect && S(!1),
                        d.p.selarrrow = [],
                        d.p.savedRow = []),
                        d.p.scroll) {
                    ...
                    d.p.shrinkToFit === !0 && i > 0 && (c = e.width - h * i - l,
                    isNaN(d.p.height) || (c -= j,
                    k = !0),
                    g = 0,
                    $.each(d.p.colModel, function(e) {
                        this.hidden !== !1 || this.fixed || (b = Math.round(c * this.width / (d.p.tblwidth - h * i - l)),
                        this.width = b,
                        g += b,
                        a = e)
                    }),
                    f = 0,
                    k ? e.width - l - (g + h * i) !== j && (f = e.width - l - (g + h * i) - j) : k || 1 === Math.abs(e.width - l - (g + h * i)) || (f = e.width - l - (g + h * i)),
                    d.p.colModel[a].width += f,
                    d.p.tblwidth = g + f + h * i + l,
                    d.p.tblwidth > d.p.width && (d.p.colModel[a].width -= d.p.tblwidth - parseInt(d.p.width, 10),
                ...
                -1 === $.inArray(d.p.multikey, x) && (d.p.multikey = !1),
                d.p.keyName = !1,
                i = 0; i < d.p.colModel.length; i++)
                    w = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {} : d.p.colModel[i].template,
                    d.p.colModel[i] = $.extend(!0, {}, d.p.cmTemplate, w || {}, d.p.colModel[i]),
                    d.p.keyName === !1 && d.p.colModel[i].key === !0 && (d.p.keyName = d.p.colModel[i].name);
                if (d.p.sortorder = d.p.sortorder.toLowerCase(),
                $.jgrid.cell_width = $.jgrid.cellWidth(),
                d.p.grouping === !0 && (d.p.scroll = !1,
                d.p.rownumbers = !1,
                d.p.treeGrid = !1,
                d.p.gridview = !0),
                this.p.treeGrid === !0) {
                ...
                if ("horizontal" === d.p.viewsortcols[1] ? (lb = " ui-i-asc",
                mb = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (lb = " ui-single-sort-asc",
                mb = " ui-single-sort-desc",
                kb = " style='display:none'",
                d.p.viewsortcols[0] = !1),
                bb = r ? "class='ui-th-div-ie'" : "",
                ib = "<span class='s-ico' style='display:none'>",
                ib += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + lb + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + kb + "></span>",
                ib += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + mb + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + kb + "></span></span>",
                d.p.multiSort && d.p.sortname)
                    for (s = d.p.sortname.split(","),
                    i = 0; i < s.length; i++)
                        u = $.trim(s[i]).split(" "),
                        s[i] = $.trim(u[0]),
                ...
                for (i = 0; i < this.p.colNames.length; i++) {
                    ...
                    d.p.multiSort && (u = $.inArray(cb, s),
                    -1 !== u && (d.p.colModel[i].lso = t[u])),
                    jb += ib + "</div></th>"
                }
                if (jb += "</tr></thead>",
                ib = null,
                ...
                this.p.multiselect) {
                    ...
                    $("#cb_" + $.jgrid.jqID(d.p.id), this).bind("click", function() {
                        ...
                        this.checked ? ($(d.rows).each(function(b) {
                            b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(m) || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !0),
                            $(this).addClass(n).attr("aria-selected", "true"),
                            d.p.selarrrow.push(this.id),
                            d.p.selrow = this.id,
                            a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !0),
                            $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).addClass(n))))
                        }),
                        ob = !0,
                        pb = []) : ($(d.rows).each(function(b) {
                            b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(m) || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !1),
                            $(this).removeClass(n).attr("aria-selected", "false"),
                            pb.push(this.id),
                            a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !1),
                            $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).removeClass(n))))
                        }),
                        d.p.selrow = null,
                        ob = !1),
                ...
                if (d.p.disableClick = !1,
                $("th", sb).each(function(a) {
                    db = d.p.colModel[a].width,
                    void 0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0),
                    d.p.colModel[a].resizable ? (eb = document.createElement("span"),
                    $(eb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"),
                    $(this).addClass(d.p.resizeclass)) : eb = "",
                    $(this).css("width", db + "px").prepend(eb),
                    eb = null;
                    var b = "";
                    d.p.colModel[a].hidden && ($(this).css("display", "none"),
                    b = "display:none;"),
                    ...
                    "boolean" != typeof kb && (d.p.colModel[a].sortable = !0,
                    kb = !0);
                    var c = d.p.colModel[a].name;
                    "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"),
                    kb && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                    d.p.colModel[a].lso && $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(),
                    $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                    a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", "")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(),
                    $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", ""))),
                    ...
                    if (1 === f.length) {
                        ...
                        if (d.p.frozenColumns) {
                            ...
                            $(d.p.colModel).each(function(a) {
                                return this.name === h ? (g = a,
                                !1) : void 0
                            })
                        } else
                            g = Z(this);
                        return d.p.viewsortcols[2] || (b = !0,
                        c = f.attr("sort")),
                        null != g && V($("div", this)[0].id, g, b, c, this),
                        !1
                    }
                }),
                d.p.sortable && $.fn.sortable)
                    try {
                ...
                vb = null,
                wb && $(e.hDiv).hide(),
                d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"),
                $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v),
                wb && $(d.p.pager).hide(),
                T(d.p.pager, "")),
                d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function(a) {
                ...
                $(d).before(e.hDiv).click(function(a) {
                    if (fb = a.target,
                    gb = $(fb, d.rows).closest("tr.jqgrow"),
                    0 === $(gb).length || gb[0].className.indexOf(m) > -1 || ($(fb, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
                        return this;
                    ...
                    if ("A" !== fb.tagName && ("INPUT" !== fb.tagName && "TEXTAREA" !== fb.tagName && "OPTION" !== fb.tagName && "SELECT" !== fb.tagName || b)) {
                        if (yb = gb[0].id,
                        fb = $(fb).closest("tr.jqgrow>td"),
                        fb.length > 0 && (zb = $.jgrid.getCellIndex(fb),
                        Ab = $(fb).closest("td,th").html(),
                        $(d).triggerHandler("jqGridCellSelect", [yb, zb, Ab, a]),
                        $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, yb, zb, Ab, a)),
                        d.p.cellEdit === !0)
                        ...
                        if (c)
                            if (d.p.multikey)
                                a[d.p.multikey] ? $(d).jqGrid("setSelection", yb, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb).is(":checked"),
                                $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                                ...
                                if (b)
                                    ...
                                    $(d.p.selarrrow).each(function(a, b) {
                                        ...
                                        g && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g)).removeClass(n),
                                        $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g))[d.p.useProp ? "prop" : "attr"]("checked", !1))
                                    }),
                                    d.p.selarrrow = [],
                                    $(d).jqGrid("setSelection", yb, !0, a)
                                }
                    ...
                    if (d.p.treeGrid === !0 && (d.p.datatype = d.p.treedatatype),
                    b = b || {},
                    b.current && d.grid.selectionPreserver(d),
                    "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"),
                    d.p.data.length && (I(),
                    J())) : d.p.treeGrid || (d.p.selrow = null,
                    d.p.multiselect && (d.p.selarrrow = [],
                    S(!1)),
                    d.p.savedRow = []),
                    d.p.scroll && H.call(d, !0, !1),
                    b.page) {
                        var c = b.page;
                    ...
                    return d.grid.prevRowHeight && d.p.scroll && void 0 === b.page ? (delete d.p.lastpage,
                    ...
                    0 !== $(gb).length) {
                        ...
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(gb).attr("id"), yb, zb, a),
                        null != b) ? b : void 0
                    }
                    ...
                    0 !== $(gb).length) {
                        ...
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(gb).attr("id"), yb, zb, a),
                        null != b) ? b : void 0
                    }
                }),
                ...
                d.p.multikey && ($.jgrid.msie ? $(e.bDiv).bind("selectstart", function() {
                    return !1
                ...
                if ($(e.cDiv).append(Db).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)),
                $(e.cDiv).insertBefore(e.hDiv),
                d.p.toolbar[0]) {
                    ...
                    "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"),
                    $(e.uDiv).addClass(Eb + " ui-userdata-top").attr("id", "t_" + this.id).insertBefore(e.hDiv).width(e.width),
                    $(e.ubDiv).addClass(Eb + " ui-userdata-bottom").attr("id", "tb_" + this.id).insertAfter(e.hDiv).width(e.width),
                    wb && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width).addClass(Eb + " ui-userdata-top").attr("id", "t_" + this.id),
                    wb && $(e.uDiv).hide()
                }
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager",
                e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0],
                d.p.toppager = "#" + d.p.toppager,
                $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv),
                T(d.p.toppager, "_t")),
                d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0],
                xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"),
                $(e.sDiv).append(xb).width(e.width).insertAfter(e.hDiv),
                $(xb).append(rb),
                e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells,
                d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")),
                wb && $(e.sDiv).hide()),
                xb = null,
                d.p.caption) {
                    var Fb = d.p.datatype;
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                        ...
                        return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")),
                        f += ", #" + $(e.uDiv).attr("id")),
                        b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length,
                        "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                            b--,
                            0 === b && ($("span", g).removeClass(Bb).addClass(Cb),
                            d.p.gridstate = "hidden",
                            $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(),
                            $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]),
                            c && (wb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
                            b--,
                            0 === b && ($("span", g).removeClass(Cb).addClass(Bb),
                            wb && (d.p.datatype = Fb,
                            R(),
                            wb = !1),
                            d.p.gridstate = "visible",
                            $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(),
                            $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]),
                            c && (wb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }),
                        !1
                    }),
                    wb && (d.p.datatype = "local",
                    $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
                } else
                    $(e.cDiv).hide(),
                    d.p.toppager || $(e.hDiv).addClass(k(d.p.styleUI + ".common", "cornertop", !0));
                if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                    return e.resizing ? (e.dragMove(a),
                    !1) : void 0
                }),
                ...
                $(d).triggerHandler("jqGridInitGrid"),
                $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d),
                R(),
                d.p.hiddengrid = !1,
                d.p.responsive) {
    ...
    $.jgrid.extend({
        ...
        setSelection: function(a, b, c) {
            return this.each(function() {
                ...
                void 0 !== a && (b = b === !1 ? !1 : !0,
                f = $(l).jqGrid("getGridRowById", a),
                !f || !f.className || f.className.indexOf(o) > -1 || (l.p.scrollrows === !0 && (g = $(l).jqGrid("getGridRowById", a).rowIndex,
                g >= 0 && d(g)),
                l.p.frozenColumns === !0 && (j = l.p.id + "_frozen"),
                ...
                e = !0,
                l.p.selarrrow.push(l.p.selrow)) : ("ui-subgrid" !== f.className && $(f).removeClass(n).attr("aria-selected", "false"),
                e = !1,
        ...
        resetSelection: function(a) {
            return this.each(function() {
                ...
                if (d.p.frozenColumns === !0 && (c = d.p.id + "_frozen"),
                void 0 !== a) {
                    ...
                    d.p.selrow = null);
                d.p.cellEdit === !0 && parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && ($("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell " + f),
        ...
        delRowData: function(a) {
            ...
            return this.each(function() {
                ...
                f.updatepager(!0, !1),
                e = !0,
                f.p.multiselect && (c = $.inArray(a, f.p.selarrrow),
                -1 !== c && f.p.selarrrow.splice(c, 1)),
                f.p.selrow = f.p.multiselect && f.p.selarrrow.length > 0 ? f.p.selarrrow[f.p.selarrrow.length - 1] : null,
                "local" === f.p.datatype) {
        ...
        addRowData: function(a, b, c, d) {
            ...
            this.each(function() {
                ...
                for (i && (t = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")),
                g && (u = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "multiBox", !1, "cbox")); x > z; ) {
                    if (p = b[z],
                    f = [],
                    y = A,
                    m) {
                    ...
                    for (r = a,
                    a = w.p.idPrefix + a,
                    i && (v = w.formatCol(0, 1, "", null, a, !0),
                    f[f.length] = '<td role="gridcell" ' + t + " " + v + ">0</td>"),
                    g && (l = '<input role="checkbox" type="checkbox" id="jqg_' + w.p.id + "_" + a + '" ' + u + "/>",
                    v = w.formatCol(i, 1, "", null, a, !0),
                    f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>"),
                    h && (f[f.length] = $(w).jqGrid("addSubGridCell", g + i, 1)),
                    k = g + h + i; k < w.p.colModel.length; k++)
                        q = w.p.colModel[k],
                        e = q.name,
                        B[e] = p[e],
                        ...
                        f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>";
                    if (f.unshift(w.constructTr(a, !1, y, B, p)),
                    f[f.length] = "</tr>",
                    0 === w.rows.length)
                        ...
                        case "after":
                            ...
                            j && ($(w.rows[j.rowIndex + 1]).hasClass("ui-subgrid") ? $(w.rows[j.rowIndex + 1]).after(f) : $(j).after(f.join("")),
                            j = j.rowIndex + 1);
                            break;
                        case "before":
                            j = $(w).jqGrid("getGridRowById", d),
                    ...
                    z++,
                    "local" === w.p.datatype && (B[w.p.localReader.id] = r,
                    w.p._index[r] = w.p.data.length,
                    w.p.data.push(B),
                    B = {})
                }
        ...
        footerData: function(a, b, c) {
            ...
            this.each(function() {
                var i, j = this;
                return j.grid && j.p.footerrow ? "set" === a && d(b) ? !1 : (g = !0,
        ...
        showHideCol: function(a, b) {
            return this.each(function() {
                ...
                if (d.grid) {
                    ...
                    e === !0 && (d.p.shrinkToFit !== !0 || isNaN(d.p.height) || (d.p.tblwidth += parseInt(d.p.scrollOffset, 10)),
                    $(d).jqGrid("setGridWidth", d.p.shrinkToFit === !0 ? d.p.tblwidth : d.p.width)),
                    h) {
        ...
        setGridWidth: function(a, b) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    if ("boolean" != typeof b && (b = g.p.shrinkToFit),
                    !isNaN(a)) {
                        if (a = parseInt(a, 10),
                        g.grid.width = g.p.width = a,
                        $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"),
                        $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"),
                        $(g.grid.bDiv).css("width", a + "px"),
                        $(g.grid.hDiv).css("width", a + "px"),
                        g.p.pager && $(g.p.pager).css("width", a + "px"),
                        g.p.toppager && $(g.p.toppager).css("width", a + "px"),
                        g.p.toolbar[0] === !0 && ($(g.grid.uDiv).css("width", a + "px"),
                        "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a + "px")),
                        g.p.footerrow && $(g.grid.sDiv).css("width", a + "px"),
                        b === !1 && g.p.forceFit === !0 && (g.p.forceFit = !1),
                        b === !0) {
                            if ($.each(g.p.colModel, function() {
                                this.hidden === !1 && (c = this.widthOrg,
                                h += c + i,
                                this.fixed ? m += c + i : j++)
                            }),
                            0 === j)
                            ...
                            g.p.tblwidth = h,
                            e = a - i * j - m,
                            isNaN(g.p.height) || ($(g.grid.bDiv)[0].clientHeight < $(g.grid.bDiv)[0].scrollHeight || 1 === g.rows.length) && (k = !0,
                            e -= l),
                            h = 0;
                            ...
                            if ($.each(g.p.colModel, function(a) {
                                if (this.hidden === !1 && !this.fixed) {
                                    if (c = this.widthOrg,
                                    c = Math.round(e * c / (g.p.tblwidth - i * j - m)),
                                    0 > c)
                                        return;
                                    this.width = c,
                                    h += c,
                            ...
                            !d)
                                return;
                            if (f = 0,
                            k ? a - m - (h + i * j) !== l && (f = a - m - (h + i * j) - l) : 1 !== Math.abs(a - m - (h + i * j)) && (f = a - m - (h + i * j)),
                            g.p.colModel[d].width += f,
                            g.p.tblwidth = h + f + i * j + m,
                            g.p.tblwidth > a) {
                        ...
                        g.p.tblwidth && ($("table:first", g.grid.bDiv).css("width", g.p.tblwidth + "px"),
                        $("table:first", g.grid.hDiv).css("width", g.p.tblwidth + "px"),
                        g.grid.hDiv.scrollLeft = g.grid.bDiv.scrollLeft,
                        g.p.footerrow && $("table:first", g.grid.sDiv).css("width", g.p.tblwidth + "px"))
                    }
                }
            })
        },
                ...
                $(a).keydown(function(c) {
                    ...
                    if (g)
                        ...
                        37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode) {
                            ...
                            $(a).triggerHandler("jqGridKeyLeft", [a.p.selrow]),
                            $.isFunction(b.onLeftKey) && b.onLeftKey.call(a, a.p.selrow)),
                            39 === c.keyCode && (a.p.treeGrid && !a.p.data[f][h] && $(g).find("div.treeclick").trigger("click"),
                            $(a).triggerHandler("jqGridKeyRight", [a.p.selrow]),
                            $.isFunction(b.onRightKey) && b.onRightKey.call(a, a.p.selrow))
                        } else
                            13 === c.keyCode ? ($(a).triggerHandler("jqGridKeyEnter", [a.p.selrow]),
                            $.isFunction(b.onEnter) && b.onEnter.call(a, a.p.selrow)) : 32 === c.keyCode && ($(a).triggerHandler("jqGridKeySpace", [a.p.selrow]),
                            $.isFunction(b.onSpace) && b.onSpace.call(a, a.p.selrow))
                })
            })
        },
        unbindKeys: function() {
        ...
        getLocalRow: function(a) {
            var b, c = !1;
            return this.each(function() {
                void 0 !== a && (b = this.p._index[$.jgrid.stripPref(this.p.idPrefix, a)],
                b >= 0 && (c = this.p.data[b]))
            }),
            c
        },
        ...
        setGridState: function(a) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    b.p.toolbar[0] === !0 && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideUp("fast"),
                    ...
                    b.p.toolbar[0] === !0 && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideDown("fast"),
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        for (a.p.rownumbers && c++,
                        a.p.multiselect && c++; d > c && b[c].frozen === !0; )
                            f = !0,
                            e = c,
                            c++;
                        if (e >= 0 && f) {
                            ...
                            if ($(k).width(1),
                            $(a.grid.fhDiv).append(k).mousemove(function(b) {
                                return a.grid.resizing ? (a.grid.dragMove(b),
                                !1) : void 0
                            }),
                            a.p.footerrow) {
                            ...
                            $(a.grid.fbDiv).bind("mousewheel DOMMouseScroll", function(b) {
                            ...
                            $(a).bind("jqGridAfterGridComplete.setFrozenColumns", function() {
        ...
        resizeColumn: function(a, b) {
            return this.each(function() {
                ...
                if ("string" == typeof a) {
                    ...
                    a = parseInt(a, 10);
                if (b = parseInt(b, 10),
                !("number" != typeof a || 0 > a || a > h.length - 1 || "number" != typeof b || b < g.minColWidth)) {
                    if (g.forceFit)
                        for (g.nv = 0,
                        c = a + 1; i > c; c++)
                            if (h[c].hidden !== !0) {
                    ...
                    d = b - f.headers[a].width,
                    g.forceFit) {
                        if (e = f.headers[a + g.nv].width - d,
                        e < g.minColWidth)
                            return;
    ...
    $.jgrid.extend({
        editCell: function(a, b, c) {
            return this.each(function() {
                var d, e, f, g, h = this, i = $(this).jqGrid("getStyleUI", h.p.styleUI + ".common", "highlight", !0), j = $(this).jqGrid("getStyleUI", h.p.styleUI + ".common", "hover", !0), k = $(this).jqGrid("getStyleUI", h.p.styleUI + ".celledit", "inputClass", !0);
                if (h.grid && h.p.cellEdit === !0) {
                    if (b = parseInt(b, 10),
                    h.p.selrow = h.rows[a].id,
                    h.p.knv || $(h).jqGrid("GridNav"),
                    h.p.savedRow.length > 0) {
                        if (c === !0 && a == h.p.iRow && b == h.p.iCol)
                            return;
                    ...
                    d = g.name,
                    "subgrid" !== d && "cb" !== d && "rn" !== d) {
                        if (f = $("td:eq(" + b + ")", h.rows[a]),
                        g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))
                            ...
                            if (h.p.autoencode && (e = $.jgrid.htmlDecode(e)),
                            ...
                            $("input, select, textarea", f).bind("keydown", function(c) {
                                if (27 === c.keyCode && ($("input.hasDatepicker", f).length > 0 ? $(".ui-datepicker").is(":hidden") ? $(h).jqGrid("restoreCell", a, b) : $("input.hasDatepicker", f).datepicker("hide") : $(h).jqGrid("restoreCell", a, b)),
                                13 === c.keyCode && !c.shiftKey)
                                    return $(h).jqGrid("saveCell", a, b),
                                    !1;
                                if (9 === c.keyCode) {
        ...
        saveCell: function(a, b) {
            return this.each(function() {
                var c, d = this, e = $.jgrid.getRegional(this, "errors"), f = $.jgrid.getRegional(this, "edit");
                if (d.grid && d.p.cellEdit === !0) {
                    if (c = d.p.savedRow.length >= 1 ? 0 : null,
                    null !== c) {
                        var g, h, i = $("td:eq(" + b + ")", d.rows[a]), j = d.p.colModel[b], k = j.name, l = $.jgrid.jqID(k);
                        switch (j.edittype) {
                        case "select":
                            if (j.editoptions.multiple) {
                                ...
                                g = $("#" + a + "_" + l + " option:selected", d.rows[a]).val(),
                        ...
                        case "custom":
                            try {
                                if (!j.editoptions || !$.isFunction(j.editoptions.custom_value))
                                    throw "e1";
                                if (g = j.editoptions.custom_value.call(d, $(".customelement", i), "get"),
                                void 0 === g)
                                    throw "e2";
                                h = g
                            } catch (p) {
                        ...
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            if (s[0] === !0) {
                                ...
                                if ($.isFunction(d.p.beforeSubmitCell) && (t = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b),
                                t || (t = {})),
                                $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"),
                                "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        var u = {};
                                        ...
                                        $.ajax($.extend({
                                            ...
                                            complete: function(c, j) {
                                                ...
                                                "success" === j) {
                                                    ...
                                                    l[0] === !0 ? ($(i).empty(),
                                                    $(d).jqGrid("setCell", d.rows[a].id, b, h, !1, !1, !0),
                                                    $(i).addClass("dirty-cell"),
                                                    $(d.rows[a]).addClass("edited"),
                                                    $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]),
                                                    $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b),
                                                    d.p.savedRow.splice(0, 1)) : ($.jgrid.info_dialog(e.errcap, l[1], f.bClose, {
                                                        styleUI: d.p.styleUI
                                                    }),
                                            ...
                                            error: function(c, g, h) {
                                                ...
                                                $.isFunction(d.p.errorCell) ? (d.p.errorCell.call(d, c, g, h),
                                                $(d).jqGrid("restoreCell", a, b)) : ($.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {
                                                    styleUI: d.p.styleUI
                                                }),
                                                $(d).jqGrid("restoreCell", a, b))
                                            }
                                ...
                                "clientArray" === d.p.cellsubmit && ($(i).empty(),
                                $(d).jqGrid("setCell", d.rows[a].id, b, h, !1, !1, !0),
                                $(i).addClass("dirty-cell"),
                                $(d.rows[a]).addClass("edited"),
                                $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]),
                ...
                if (c.grid && c.p.cellEdit === !0) {
                    ...
                    $("#" + c.p.knv).focus().keydown(function(f) {
                        ...
                        case 38:
                            ...
                            $(c).jqGrid("editCell", c.p.iRow - 1, c.p.iCol, !1));
                            break;
                        case 40:
                        ...
                        case 37:
                            ...
                            a(c.p.iRow, d, "h"),
                            $(c).jqGrid("editCell", c.p.iRow, d, !1));
                            break;
                        case 39:
    ...
    $.extend($.jgrid, {
        ...
        viewModal: function(a, b) {
            ...
            void 0 === b.focusField && (b.focusField = 0),
            b.focusField = "number" == typeof b.focusField && b.focusField >= 0 ? parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? 0 : !1,
            $.fn.jqm && b.jqm === !0)
                b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();
            else if ("" !== b.gbox && ($(".jqgrid-overlay:first", b.gbox).show(),
            $(a).data("gbox", b.gbox)),
            ...
            case "select":
                ...
                null != b.dataUrl) {
                    ...
                    $.ajax($.extend({
                        ...
                        success: function(a) {
                            var b, c = [], d = this.elem, e = this.vl, g = $.extend({}, this.options), i = g.multiple === !0, j = g.cacheUrlData === !0, k = "", l = $.isFunction(g.buildSelect) ? g.buildSelect.call(h, a) : a;
                                ...
                                j)
                                    if ("edit" === g.oper)
                                        ...
                                        $.each(f, function() {
                                            ...
                                            g.name === a ? (this.searchoptions.dataUrl = null,
                    ...
                    var q, r, s, t, u, v, w = void 0 === b.separator ? ":" : b.separator, x = void 0 === b.delimiter ? ";" : b.delimiter;
                    if ("string" == typeof b.value)
                        for (q = b.value.split(x),
                        p = 0; p < q.length; p++)
                            r = q[p].split(w),
                            r.length > 2 && (r[1] = $.map(r, function(a, b) {
                                return b > 0 ? a : void 0
                            }).join(w)),
                        ...
                        p = 0; p < t.length; p++)
                            ...
                            s.innerHTML = v,
                            g.appendChild(s),
                            k || $.trim(u) !== $.trim(c) && $.trim(v) !== $.trim(c) || (s.selected = "selected"),
                            k && ($.inArray($.trim(v), l) > -1 || $.inArray($.trim(u), l) > -1) && (s.selected = "selected"));
                    else if ("object" == typeof b.value) {
                        t = b.value;
                        for (u in t)
                            t.hasOwnProperty(u) && (s = document.createElement("option"),
                            s.setAttribute("role", "option"),
                            s.value = u,
                            s.innerHTML = t[u],
                            g.appendChild(s),
                            k || $.trim(u) !== $.trim(c) && $.trim(t[u]) !== $.trim(c) || (s.selected = "selected"),
                            k && ($.inArray($.trim(t[u]), l) > -1 || $.inArray($.trim(u), l) > -1) && (s.selected = "selected"))
                    }
                    f(g, b, ["value"])
                }
                break;
        ...
        checkDate: function(a, b) {
            ...
            return -1 === h ? !1 : (l = e[a[h]].toString(),
            2 === f && 1 === l.length && (f = 1),
            l.length !== f || 0 === e[a[h]] && "00" !== b[h] ? !1 : -1 === j ? !1 : (l = e[a[j]].toString(),
            l.length < 1 || e[a[j]] < 1 || e[a[j]] > 12 ? !1 : -1 === i ? !1 : (l = e[a[i]].toString(),
            l.length < 1 || e[a[i]] < 1 || e[a[i]] > 31 || 2 === e[a[j]] && e[a[i]] > d(e[a[h]]) || e[a[i]] > m[e[a[j]]] ? !1 : !0)))
        },
        isEmpty: function(a) {
        ...
        checkValues: function(a, b, c, d) {
            ...
            if (e) {
                ...
                e.required === !0 && $.jgrid.isEmpty(a))
                    return [!1, g + ": " + m.required, ""];
                var n = e.required === !1 ? !1 : !0;
                if (e.number === !0 && (n !== !1 || !$.jgrid.isEmpty(a)) && isNaN(a))
                    return [!1, g + ": " + m.number, ""];
                ...
                var o;
                if (e.email === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (o = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,
                o.test(a))))
                    return [!1, g + ": " + m.email, ""];
                ...
                if (e.date === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (l[b].formatoptions && l[b].formatoptions.newformat ? (h = l[b].formatoptions.newformat,
                j = $.jgrid.getRegional(k, "formatter.date.masks"),
                j && j.hasOwnProperty(h) && (h = j[h])) : h = l[b].datefmt || "Y-m-d",
                $.jgrid.checkDate(h, a))))
                    return [!1, g + ": " + m.date + " - " + h, ""];
                if (e.time === !0 && !(n === !1 && $.jgrid.isEmpty(a) || $.jgrid.checkTime(a)))
                    return [!1, g + ": " + m.date + " - hh:mm (am/pm)", ""];
                if (e.url === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (o = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i,
                o.test(a))))
                    return [!1, g + ": " + m.url, ""];
            ...
            if (!this.filter) {
                ...
                c) {
                    ...
                    this.createTableForGroup = function(a, b) {
                        ...
                        var o = "<span></span>";
                        if (this.p.groupButton && (o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + i.button + "'/>"),
                        ...
                        void 0 !== a.rules)
                            for (c = 0; c < a.rules.length; c++)
                                f.append(this.createTableRowForRule(a.rules[c], a));
                        return f
                    }
                    ,
                    this.createTableRowForRule = function(a, b) {
                        ...
                        o.append(q);
                        var r, s = $("<select class='" + h.srSelect + "'></select>"), t = [];
                        q.append(s),
                        s.bind("change", function() {
                            ...
                            if (k) {
                                ...
                                c = 0; c < g.length; c++)
                                    r = $.inArray(g[c], t),
                                    -1 !== r && (0 === f && (a.op = m.p.ops[r].oper),
                                    d += "<option value='" + m.p.ops[r].oper + "'>" + m.p.ops[r].text + "</option>",
                                    f++);
                                if ($(".selectopts", j).empty().append(d),
                                ...
                                $(".input-elm", j).bind("change", function(b) {
                                    var c = b.target;
                        ...
                        ("nu" === a.op || "nn" === a.op) && ($(z).attr("readonly", "true"),
                        ...
                        c = 0; c < g.length; c++)
                            r = $.inArray(g[c], t),
                            -1 !== r && (l = a.op === m.p.ops[r].oper ? " selected='selected'" : "",
                        ...
                        $(z).addClass("input-elm " + h.srInput).bind("change", function() {
                    ...
                    this.getStringForRule = function(a) {
                        var b, c, e, f, g = "", h = "", i = ["int", "integer", "float", "number", "currency"];
                        ...
                        return void 0 === c ? "" : (f = a.data,
                        ("bw" === h || "bn" === h) && (f += "%"),
                        ("ew" === h || "en" === h) && (f = "%" + f),
                        ("cn" === h || "nc" === h) && (f = "%" + f + "%"),
                        ("in" === h || "ni" === h) && (f = " (" + f + ")"),
                        d.errorcheck && j(a.data, c),
                        e = -1 !== $.inArray(c.searchtype, i) || "nn" === h || "nu" === h ? a.field + " " + g + " " + f : a.field + " " + g + ' "' + f + '"')
                    }
                    ,
        ...
        filterToolbar: function(a) {
            ...
            this.each(function() {
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, f = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, h = function() {
                        var b, d, e, f = {}, g = 0, h = {};
                        $.each(c.p.colModel, function() {
                            ...
                            e = a.searchOperators ? i.parent().prev().children("a").attr("soper") || a.defaultSearch : this.searchoptions && this.searchoptions.sopt ? this.searchoptions.sopt[0] : "select" === this.stype ? "eq" : a.defaultSearch,
                            b = "custom" === this.stype && $.isFunction(this.searchoptions.custom_value) && i.length > 0 && "SPAN" === i[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, i.children(".customelement:first"), "get") : i.val(),
                            b || "nu" === e || "nn" === e)
                                f[d] = b,
                                h[d] = e,
                                g++;
                        ...
                        a.stringResult === !0 || "local" === c.p.datatype) {
                        ...
                        d = parseInt(d, 10),
                        g = parseInt(g, 10) + 18;
                        for (var i, j, k = $(".ui-jqgrid-view").css("font-size") || "11px", l = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + k + ";left:" + d + "px;top:" + g + 'px;">', m = $(b).attr("soper"), n = [], o = 0, p = $(b).attr("colname"), q = c.p.colModel.length; q > o && c.p.colModel[o].name !== p; )
                            o++;
                        ...
                        o = 0; o < s.sopt.length; o++)
                            j = $.inArray(s.sopt[o], n),
                            -1 !== j && (i = m === a.odata[j].oper ? f.highlight : "",
                            l += '<li class="ui-menu-item ' + i + '" role="presentation"><a class="' + f.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[j].oper + '" oper="' + a.operands[a.odata[j].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + a.operands[a.odata[j].oper] + "</td><td>" + a.odata[j].text + "</td></tr></table></a></li>");
                        l += "</ul>",
                        $("body").append(l),
                    ...
                    $.each(c.p.colModel, function(b) {
                        var f, i, j, k, m, n, o, p = this, q = "", r = "=", s = $("<th role='columnheader' class='" + g.headerBox + " ui-th-" + c.p.direction + "' id='gsh_" + c.p.id + "_" + p.name + "' ></th>"), t = $("<div></div>"), u = $("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");
                        if (this.hidden === !0 && $(s).css("display", "none"),
                        ...
                        this.search) {
                            if (a.searchOperators) {
                                for (i = f.sopt ? f.sopt[0] : "select" === p.stype ? "eq" : a.defaultSearch,
                                j = 0; j < a.odata.length; j++)
                                    if (a.odata[j].oper === i) {
                                        r = a.operands[i] || "";
                                        break
                                    }
                            ...
                            switch ($("td:eq(0)", u).attr("colindex", b).append(q),
                            void 0 === f.clearSearch && (f.clearSearch = !0),
                            f.clearSearch ? (m = a.resetTitle || "Clear Search Value",
                            $("td:eq(2)", u).append("<a title='" + m + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>")) : $("td:eq(2)", u).hide(),
                            this.surl && (f.dataUrl = this.surl),
                            n = "",
                            f.defaultValue && (n = $.isFunction(f.defaultValue) ? f.defaultValue.call(c) : f.defaultValue),
                            o = $.jgrid.createEl.call(c, this.stype, f, n, !1, $.extend({}, $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})),
                            $(o).css({
                                width: "100%"
                            }).addClass(e.srInput),
                            $("td:eq(1)", u).append(o),
            ...
            this.each(function() {
                ...
                if (c.grid) {
                    var d, e = "fbox_" + c.p.id, f = !0, g = !0, h = {
                        ...
                        scrollelm: e
                    }, i = c.p.postData[a.sFilter], j = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, k = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common;
                    if (a.styleUI = c.p.styleUI,
                    "string" == typeof i && (i = $.jgrid.parse(i)),
                    a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(),
                    void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0])
                        ...
                        l.attr("dir", "rtl"));
                        var o, p, q = $.extend([], c.p.colModel), r = "<a id='" + e + "_search' class='fm-button " + k.button + " fm-button-icon-right ui-search'><span class='" + k.icon_base + " " + j.icon_search + "'></span>" + a.Find + "</a>", s = "<a id='" + e + "_reset' class='fm-button " + k.button + " fm-button-icon-left ui-reset'><span class='" + k.icon_base + " " + j.icon_reset + "'></span>" + a.Reset + "</a>", t = "", u = "", v = !1, w = -1;
                        if (a.showQuery && (t = "<a id='" + e + "_query' class='fm-button " + k.button + " fm-button-icon-left'><span class='" + k.icon_base + " " + j.icon_query + "'></span>Query</a>"),
                        a.columns.length ? (q = a.columns,
                        w = 0,
                        ...
                        u += "<td><select class='ui-template " + j.srSelect + "'>",
                        ...
                        l.append(p),
                        v && a.tmplFilters && a.tmplFilters.length && $(".ui-template", l).bind("change", function() {
                            var b = $(this).val();
                        ...
                        $("#" + e + "_search").bind("click", function() {
                            var b, f, i = {};
                            if (d = $("#" + e),
                            d.find(".input-elm:focus").change(),
                            f = d.jqFilter("filterData"),
    ...
    if ($.jgrid.extend({
        editGridRow: function(a, b) {
            ...
            this.each(function() {
                        ...
                        if (a.length) {
                            ...
                            $.each(p.p.colModel, function() {
                                if (this.name === c && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (r[c] = this.editoptions.custom_value.call(p, $("#" + $.jgrid.jqID(c), x), "get"),
                                        void 0 === r[c])
                                            throw "e1"
                                    } catch (a) {
                ...
                function d(a, b, c, d) {
                    var f, g, h, i, j, k, l, m = 0, n = [], o = !1, q = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", r = "";
                    for (l = 1; d >= l; l++)
                        r += q;
                    if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)),
                    $(b.p.colModel).each(function(l) {
                        if (f = this.name,
                        g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1,
                        j = g ? "style='display:none'" : "",
                        "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                            if (o === !1)
                                i = "";
                            else if (f === b.p.ExpandColumn && b.p.treeGrid === !0)
                                i = $("td[role='gridcell']:eq(" + l + ")", b.rows[o]).text();
                            else {
                                try {
                            ...
                            if ("_empty" === a && s.defaultValue && (i = $.isFunction(s.defaultValue) ? s.defaultValue.call(p) : s.defaultValue),
                            this.edittype || (this.edittype = "text"),
                            p.p.autoencode && (i = $.jgrid.htmlDecode(i)),
                            k = $.jgrid.createEl.call(p, this.edittype, s, i, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {})),
                            ...
                            (rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[f] = i),
                            $(k).addClass("FormElement"),
                            $.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && $(k).addClass(e.inputClass),
                            C)
                                $(I).find("#" + f).replaceWith(k);
                            else {
                                ...
                                0 === h.length && (h = $("<tr " + j + " rowpos='" + u + "'></tr>").addClass("FormData").attr("id", "tr_" + f),
                                $(h).append(r),
                                $(c).append(h),
                                h[0].rp = u),
                    ...
                    m > 0) {
                        var s;
                        C ? (s = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/>",
                        $(I).append(s)) : (s = $("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * d - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/></td></tr>"),
                        s[0].rp = m + 999,
                        $(c).append(s)),
                ...
                function g(a, b, c) {
                    var d, e, f, g, h, i, j = 0;
                    (rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData = {},
                    ...
                    if ("_empty" === a)
                        return $(k).each(function() {
                            ...
                            f = $("#" + $.jgrid.jqID(d), c),
                            f && f.length && null !== f[0] && (h = "",
                            "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(p, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(p) : g.defaultValue,
                            ...
                            (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = h))
                        }),
                        void $("#id_g", c).val(a);
                    var l = $(b).jqGrid("getInd", a, !0);
                    l && ($('td[role="gridcell"]', l).each(function(f) {
                        if (d = k[f].name,
                        "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                            if (d === b.p.ExpandColumn && b.p.treeGrid === !0)
                                e = $(this).text();
                            else
                                try {
                            ...
                            switch (p.p.autoencode && (e = $.jgrid.htmlDecode(e)),
                            (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = e),
                            d = $.jgrid.jqID(d),
                            k[f].edittype) {
                            case "password":
                            case "text":
                            ...
                            case "select":
                                ...
                                (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (e = $("#" + d, c).val(),
                                k[f].editoptions.multiple && (e = e.join(",")),
                                rp_ge[p.p.id]._savedData[d] = e);
                                break;
                            case "checkbox":
                                if (e = String(e),
                                k[f].editoptions && k[f].editoptions.value) {
                                    ...
                                    e = e.toLowerCase(),
                                    e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e ? ($("#" + d, c)[p.p.useProp ? "prop" : "attr"]("checked", !0),
                                    $("#" + d, c)[p.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : ($("#" + d, c)[p.p.useProp ? "prop" : "attr"]("checked", !1),
                                    $("#" + d, c)[p.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                ...
                function i() {
                    var a, c, d, e, i, j, k, l = [!0, "", ""], m = {}, n = p.p.prmNames, o = $(p).triggerHandler("jqGridAddEditBeforeCheckValues", [$(v), t]);
                    o && "object" == typeof o && (r = o),
                    $.isFunction(rp_ge[p.p.id].beforeCheckValues) && (o = rp_ge[p.p.id].beforeCheckValues.call(p, r, $(v), t),
                    o && "object" == typeof o && (r = o));
                    for (e in r)
                        if (r.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(p, r[e], e),
                        l[0] === !1))
                            break;
                    if (h(),
                    l[0] && (m = $(p).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[p.p.id], r, t]),
                    void 0 === m && $.isFunction(rp_ge[p.p.id].onclickSubmit) && (m = rp_ge[p.p.id].onclickSubmit.call(p, rp_ge[p.p.id], r, t) || {}),
                    l = $(p).triggerHandler("jqGridAddEditBeforeSubmit", [r, $(v), t]),
                    void 0 === l && (l = [!0, "", ""]),
                    l[0] && $.isFunction(rp_ge[p.p.id].beforeSubmit) && (l = rp_ge[p.p.id].beforeSubmit.call(p, r, $(v), t))),
                    l[0] && !rp_ge[p.p.id].processing) {
                        if (rp_ge[p.p.id].processing = !0,
                        $("#sData", x + "_2").addClass(f.active),
                        k = rp_ge[p.p.id].url || $(p).jqGrid("getGridParam", "editurl"),
                        d = n.oper,
                        c = "clientArray" === k ? p.p.keyName : n.id,
                        r[d] = "_empty" === $.trim(r[p.p.id + "_id"]) ? n.addoper : n.editoper,
                        r[d] !== n.addoper ? r[c] = r[p.p.id + "_id"] : void 0 === r[c] && (r[c] = r[p.p.id + "_id"]),
                        delete r[p.p.id + "_id"],
                        r = $.extend(r, rp_ge[p.p.id].editData, m),
                        p.p.treeGrid === !0) {
                            if (r[d] === n.addoper) {
                            ...
                            for (j in p.p.treeReader)
                                if (p.p.treeReader.hasOwnProperty(j)) {
                                    ...
                                    if (r.hasOwnProperty(s)) {
                                        if (r[d] === n.addoper && "parent_id_field" === j)
                                            continue;
                                        delete r[s]
                                    }
                                }
                        ...
                        var w = $.extend({
                            ...
                            complete: function(e, h) {
                                var j;
                                if ($("#sData", x + "_2").removeClass(f.active),
                                r[c] = p.p.idPrefix + r[c],
                                e.status >= 300 && 304 !== e.status ? (l[0] = !1,
                                l[1] = $(p).triggerHandler("jqGridAddEditErrorTextFormat", [e, t]),
                                l[1] = $.isFunction(rp_ge[p.p.id].errorTextFormat) ? rp_ge[p.p.id].errorTextFormat.call(p, e, t) : h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(p).triggerHandler("jqGridAddEditAfterSubmit", [e, r, t]),
                                void 0 === l && (l = [!0, "", ""]),
                                l[0] && $.isFunction(rp_ge[p.p.id].afterSubmit) && (l = rp_ge[p.p.id].afterSubmit.call(p, e, r, t))),
                                l[0] === !1)
                                    $(".FormError", v).html(l[1]),
                                    $(".FormError", v).show();
                                else if (p.p.autoencode && $.each(r, function(a, b) {
                                    r[a] = $.jgrid.htmlDecode(b)
                                }),
                                r[d] === n.addoper ? (l[2] || (l[2] = $.jgrid.randId()),
                                null == r[c] || "_empty" === r[c] ? r[c] = l[2] : l[2] = r[c],
                                rp_ge[p.p.id].reloadAfterSubmit ? $(p).trigger("reloadGrid") : p.p.treeGrid === !0 ? $(p).jqGrid("addChildNode", l[2], i, r) : $(p).jqGrid("addRowData", l[2], r, b.addedrow),
                                rp_ge[p.p.id].closeAfterAdd ? (p.p.treeGrid !== !0 && $(p).jqGrid("setSelection", l[2]),
                                ...
                                })) : rp_ge[p.p.id].clearAfterAdd && g("_empty", p, v)) : (rp_ge[p.p.id].reloadAfterSubmit ? ($(p).trigger("reloadGrid"),
                                rp_ge[p.p.id].closeAfterEdit || setTimeout(function() {
                                    $(p).jqGrid("setSelection", r[c])
                                }, 1e3)) : p.p.treeGrid === !0 ? $(p).jqGrid("setTreeRow", r[c], r) : $(p).jqGrid("setRowData", r[c], r),
                                rp_ge[p.p.id].closeAfterEdit && $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + $.jgrid.jqID(u),
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                                ...
                                $.isFunction(rp_ge[p.p.id].afterComplete) && (a = e,
                                setTimeout(function() {
                                    $(p).triggerHandler("jqGridAddEditAfterComplete", [a, r, $(v), t]),
                                    rp_ge[p.p.id].afterComplete.call(p, a, r, $(v), t),
                                    a = null
                                }, 500)),
                                (rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) && ($(v).data("disabled", !1),
                                "_empty" !== rp_ge[p.p.id]._savedData[p.p.id + "_id"]))
                                    for (j in rp_ge[p.p.id]._savedData)
                                        rp_ge[p.p.id]._savedData.hasOwnProperty(j) && r[j] && (rp_ge[p.p.id]._savedData[j] = r[j]);
                        ...
                        if (w.url || rp_ge[p.p.id].useDataProxy || ($.isFunction(p.p.dataProxy) ? rp_ge[p.p.id].useDataProxy = !0 : (l[0] = !1,
                        l[1] += " " + D.nourl)),
                        l[0])
                            if (rp_ge[p.p.id].useDataProxy) {
                                ...
                                void 0 === z && (z = [!0, ""]),
                                z[0] === !1 ? (l[0] = !1,
                                l[1] = z[1] || "Error deleting the selected row!") : (w.data.oper === n.addoper && rp_ge[p.p.id].closeAfterAdd && $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + $.jgrid.jqID(u),
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                                ...
                                "clientArray" === w.url ? (rp_ge[p.p.id].reloadAfterSubmit = !1,
                                r = w.data,
                                w.complete({
                                    status: 200,
                                    statusText: ""
                ...
                function k() {
                    ...
                    c(),
                    s = j(r, rp_ge[p.p.id]._savedData),
                    s && ($(v).data("disabled", !0),
                    $(".confirm", "#" + y.themodal).show(),
                    a = !1)),
                    a
                }
                function l() {
                ...
                var p = this;
                if (p.grid && a) {
                    var q, r, s, t, u = p.p.id, v = "FrmGrid_" + u, w = "TblGrid_" + u, x = "#" + $.jgrid.jqID(w), y = {
                        themodal: "editmod" + u,
                        modalhead: "edithd" + u,
                        modalcontent: "editcnt" + u,
                        scrollelm: v
                    }, z = !0, A = 1, B = 0, C = "string" == typeof rp_ge[p.p.id].template && rp_ge[p.p.id].template.length > 0, D = $.jgrid.getRegional(this, "errors");
                    rp_ge[p.p.id].styleUI = p.p.styleUI || "jQueryUI",
                    $.jgrid.isMobile() && (rp_ge[p.p.id].resize = !1),
                    "new" === a ? (a = "_empty",
                    t = "add",
                    b.caption = rp_ge[p.p.id].addCaption) : (b.caption = rp_ge[p.p.id].editCaption,
                    t = "edit"),
                    b.recreateForm || $(p).data("formProp") && $.extend(rp_ge[$(this)[0].p.id], $(p).data("formProp"));
                    var E = !0;
                    b.checkOnUpdate && b.jqModal && !b.modal && (E = !1);
                    var F, G = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px", H = isNaN(rp_ge[$(this)[0].p.id].datawidth) ? rp_ge[$(this)[0].p.id].datawidth : rp_ge[$(this)[0].p.id].datawidth + "px", I = $("<form name='FormPost' id='" + v + "' class='FormGrid' onSubmit='return false;' style='width:" + H + ";height:" + G + ";'></form>").data("disabled", !1);
                    if (C ? (F = o(rp_ge[$(this)[0].p.id].template),
                    q = x) : (F = $("<table id='" + w + "' class='EditTable ui-common-table'><tbody></tbody></table>"),
                    q = x + "_2"),
                    v = "#" + $.jgrid.jqID(v),
                    $(I).append("<div class='FormError " + f.error + "' style='display:none;'></div>"),
                    $(I).append("<div class='tinfo topinfo'>" + rp_ge[p.p.id].topinfo + "</div>"),
                    $(p.p.colModel).each(function() {
                        var a = this.formoptions;
                        A = Math.max(A, a ? a.colpos || 0 : 0),
                        B = Math.max(B, a ? a.rowpos || 0 : 0)
                    }),
                    $(I).append(F),
                    z = $(p).triggerHandler("jqGridAddEditBeforeInitData", [I, t]),
                    void 0 === z && (z = !0),
                    z && $.isFunction(rp_ge[p.p.id].beforeInitData) && (z = rp_ge[p.p.id].beforeInitData.call(p, I, t)),
                    z !== !1) {
                        l(),
                        d(a, p, F, A);
                        ...
                        var S = !1;
                        b.closeOnEscape === !0 && (b.closeOnEscape = !1,
                        S = !0);
                        var T;
                        if (C ? ($(I).find("#pData").replaceWith(M),
                        $(I).find("#nData").replaceWith(N),
                        $(I).find("#sData").replaceWith(O),
                        $(I).find("#cData").replaceWith(P),
                        T = $("<div id=" + w + "></div>").append(I)) : T = $("<div></div>").append(I).append(Q),
                        $(I).append("<div class='binfo topinfo bottominfo'>" + rp_ge[p.p.id].bottominfo + "</div>"),
                        $.jgrid.createModal(y, T, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(p.p.id), $("#gbox_" + $.jgrid.jqID(p.p.id))[0]),
                        J && ($("#pData, #nData", x + "_2").css("float", "right"),
                        $(".EditButton", x + "_2").css("text-align", "left")),
                        rp_ge[p.p.id].topinfo && $(".tinfo", v).show(),
                        rp_ge[p.p.id].bottominfo && $(".binfo", v).show(),
                        T = null,
                        Q = null,
                        $("#" + $.jgrid.jqID(y.themodal)).keydown(function(a) {
                            var c = a.target;
                            if ($(v).data("disabled") === !0)
                                return !1;
                            if (rp_ge[p.p.id].savekey[0] === !0 && a.which === rp_ge[p.p.id].savekey[1] && "TEXTAREA" !== c.tagName)
                                return $("#sData", x + "_2").trigger("click"),
                                !1;
                            if (27 === a.which)
                                return k() ? (S && $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: b.gbox,
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                            ...
                            if (rp_ge[p.p.id].navkeys[0] === !0) {
                                if ("_empty" === $("#id_g", x).val())
                                    return !0;
                                if (a.which === rp_ge[p.p.id].navkeys[1])
                                    return $("#pData", q).trigger("click"),
                                    !1;
                                if (a.which === rp_ge[p.p.id].navkeys[2])
                                    return $("#nData", q).trigger("click"),
                                    !1
                            }
                        }),
                        b.checkOnUpdate && ($("a.ui-jqdialog-titlebar-close span", "#" + $.jgrid.jqID(y.themodal)).removeClass("jqmClose"),
                        $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(y.themodal)).unbind("click").click(function() {
                        ...
                        b.saveicon[0] === !0 && $("#sData", q).addClass("right" === b.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.saveicon[2] + "'></span>"),
                        b.closeicon[0] === !0 && $("#cData", q).addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.closeicon[2] + "'></span>"),
                        rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) {
                        ...
                        $("#sData", q).click(function() {
                            ...
                            $(".FormError", v).hide(),
                            c(),
                            "_empty" === r[p.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (s = j(r, rp_ge[p.p.id]._savedData),
                            s ? ($(v).data("disabled", !0),
                            $(".confirm", "#" + $.jgrid.jqID(y.themodal)).show()) : i()) : i(),
                            !1
                        }),
                        ...
                        $("#nData", q).click(function() {
                            ...
                            -1 !== a[0] && a[1][a[0] + 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(p, "next", $(v), a[1][a[0]]),
                                void 0 !== c && c === !1))
                                    return !1;
                        ...
                        $("#pData", q).click(function() {
                            ...
                            if (-1 !== a[0] && a[1][a[0] - 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(p, "prev", $(v), a[1][a[0]]),
                                void 0 !== c && c === !1))
                                    return !1;
                                if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass(f.disabled))
                                    return !1;
            ...
            this.each(function() {
                ...
                function d(a, c, d, e) {
                    ...
                    $(c.p.colModel).each(function(a) {
                        ...
                        o = "boolean" != typeof this.viewable ? !0 : this.viewable,
                ...
                function g(a, b) {
                    ...
                    f && ($("td", f).each(function(a) {
                        ...
                        "cb" !== c && "subgrid" !== c && "rn" !== c && (e = c === b.p.ExpandColumn && b.p.treeGrid === !0 ? $(this).text() : $(this).html(),
                        c = $.jgrid.jqID("v_" + c),
                        $("#" + c + " span", "#" + m).html(e),
                ...
                if (j.grid && a) {
                    ...
                    r !== !1) {
                        ...
                        y && ($("#pData, #nData", "#" + m + "_2").css("float", "right"),
                        ...
                        $("#nData", "#" + m + "_2").click(function() {
                            ...
                            -1 !== a[0] && a[1][a[0] + 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(j, "next", $("#" + l), a[1][a[0]]),
                            g(a[1][a[0] + 1], j),
                        ...
                        $("#pData", "#" + m + "_2").click(function() {
                            $("#FormError", "#" + m).hide();
                            var a = i();
                            return -1 !== a[0] && a[1][a[0] - 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(j, "prev", $("#" + l), a[1][a[0]]),
                            g(a[1][a[0] - 1], j),
                            $(j).jqGrid("setSelection", a[1][a[0] - 1]),
        ...
        delGridRow: function(a, b) {
            ...
            this.each(function() {
                var c = this;
                if (c.grid && a) {
                    var d, g, h, i, j = $.isFunction(rp_ge[c.p.id].beforeShowForm), k = $.isFunction(rp_ge[c.p.id].afterShowForm), l = $.isFunction(rp_ge[c.p.id].beforeInitData) ? rp_ge[c.p.id].beforeInitData : !1, m = c.p.id, n = {}, o = !0, p = "DelTbl_" + $.jgrid.jqID(m), q = "DelTbl_" + m, r = {
                        themodal: "delmod" + m,
                        modalhead: "delhd" + m,
                    ...
                    $.isArray(a) && (a = a.join()),
                    void 0 !== $("#" + $.jgrid.jqID(r.themodal))[0]) {
                        if (l && (o = l.call(c, $("#" + p)),
                        void 0 === o && (o = !0)),
                        o === !1)
                            return;
                        $("#DelData>td", "#" + p).text(a),
                        $("#DelError", "#" + p).hide(),
                        rp_ge[c.p.id].processing === !0 && (rp_ge[c.p.id].processing = !1,
                        $("#dData", "#" + p).removeClass(f.active)),
                        ...
                        if (u += "<table class='EditTable ui-common-table' id='" + p + "_2'><tbody><tr><td><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + v + "&#160;" + w + "</td></tr></tbody></table>",
                        b.gbox = "#gbox_" + $.jgrid.jqID(m),
                        $.jgrid.createModal(r, u, rp_ge[c.p.id], "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0]),
                        l && (o = l.call(c, $(u)),
                        void 0 === o && (o = !0)),
                        o === !1)
                            return;
                        ...
                        $("#dData", "#" + p + "_2").click(function() {
                            var a, e = [!0, ""], j = $("#DelData>td", "#" + p).text();
                            if (n = {},
                            $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}),
                            $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)),
                            e[0] && !rp_ge[c.p.id].processing) {
                                if (rp_ge[c.p.id].processing = !0,
                                h = c.p.prmNames,
                                d = $.extend({}, rp_ge[c.p.id].delData, n),
                                i = h.oper,
                                d[i] = h.deloper,
                                g = h.id,
                                j = String(j).split(","),
                                !j.length)
                                    return !1;
                                for (a in j)
                                    j.hasOwnProperty(a) && (j[a] = $.jgrid.stripPref(c.p.idPrefix, j[a]));
                                d[g] = j.join(),
                                ...
                                var k = $.extend({
                                    ...
                                    complete: function(a, g) {
                                        var h;
                                        if ($("#dData", "#" + p + "_2").removeClass(f.active),
                                        a.status >= 300 && 304 !== a.status ? (e[0] = !1,
                                        e[1] = $.isFunction(rp_ge[c.p.id].errorTextFormat) ? rp_ge[c.p.id].errorTextFormat.call(c, a) : g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)),
                                        e[0] === !1)
                                            $("#DelError>td", "#" + p).html(e[1]),
                                            $("#DelError", "#" + p).show();
                                        else {
                                            if (rp_ge[c.p.id].reloadAfterSubmit && "local" !== c.p.datatype)
                                                ...
                                                if (c.p.treeGrid === !0)
                                                    ...
                                                    for (h = 0; h < j.length; h++)
                                                        $(c).jqGrid("delRowData", c.p.idPrefix + j[h]);
                                                c.p.selrow = null,
                                                c.p.selarrrow = []
                                            }
                                ...
                                if (k.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = !0 : (e[0] = !1,
                                ...
                                e[0])
                                    if (rp_ge[c.p.id].useDataProxy) {
                                        ...
                                        void 0 === l && (l = [!0, ""]),
                                        l[0] === !1 ? (e[0] = !1,
                                        e[1] = l[1] || "Error deleting the selected row!") : $.jgrid.hideModal("#" + $.jgrid.jqID(r.themodal), {
                                            gb: "#gbox_" + $.jgrid.jqID(m),
                                            jqm: b.jqModal,
                                            onClose: rp_ge[c.p.id].onClose
                                        })
                                    } else
                                        "clientArray" === k.url ? (d = k.data,
                                        k.complete({
                                            status: 200,
                                            statusText: ""
                                        }, "")) : $.ajax(k)
                            }
                            return e[0] === !1 && ($("#DelError>td", "#" + p).html(e[1]),
                            $("#DelError", "#" + p).show()),
                            !1
                        }),
            ...
            this.each(function() {
                if (!this.p.navGrid) {
                    ...
                    if (o.grid && "string" == typeof a) {
                        ...
                        void 0 === $("#" + n.themodal)[0] && (m.alerttop || m.alertleft || (void 0 !== window.innerWidth ? (m.alertleft = window.innerWidth,
                        ...
                        var p, q = 1, r = function() {
                            $(this).hasClass(k.disabled) || $(this).addClass(k.hover)
                        }, s = function() {
                            $(this).removeClass(k.hover)
                        };
                        for (m.cloneToTop && o.p.toppager && (q = 2),
                        p = 0; q > p; p++) {
                            var t, u, v, w = $("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"), x = "<td class='ui-pg-button " + k.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>";
                            0 === p ? (u = a,
                            v = o.p.id,
                            u === o.p.toppager && (v += "_top",
                            q = 1)) : (u = o.p.toppager,
                            v = o.p.id + "_top"),
                            "rtl" === o.p.direction && $(w).attr("dir", "rtl").css("float", "right"),
                            d = d || {},
                            m.add && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.addicon + "'></span>" + m.addtext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                                title: m.addtitle || "",
                                id: d.id || "add_" + v
                            ...
                            t = null),
                            c = c || {},
                            m.edit && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.editicon + "'></span>" + m.edittext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                                title: m.edittitle || "",
                                id: c.id || "edit_" + v
                            ...
                            t = null),
                            g = g || {},
                            m.view && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.viewicon + "'></span>" + m.viewtext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                                title: m.viewtitle || "",
                                id: g.id || "view_" + v
                            ...
                            t = null),
                            e = e || {},
                            m.del && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.delicon + "'></span>" + m.deltext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                                title: m.deltitle || "",
                                id: e.id || "del_" + v
                            ...
                            f = f || {},
                            m.search && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.searchicon + "'></span>" + m.searchtext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                                title: m.searchtitle || "",
                                id: f.id || "search_" + v
                            ...
                            f.showOnLoad && f.showOnLoad === !0 && $(t, w).click(),
                            t = null),
                            m.refresh && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"),
                            $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.refreshicon + "'></span>" + m.refreshtext + "</div>"),
                            $("tr", w).append(t),
                            $(t, w).attr({
                            ...
                            $("#testpg2").remove(),
                            o.p._nvtd && (m.dropmenu ? (w = null,
                            $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g)) : j > o.p._nvtd[0] ? (o.p.responsive ? (w = null,
                            $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g)) : $(u + "_" + m.position, u).width(j),
                            o.p._nvtd[0] = j) : $(u + "_" + m.position, u).append(w),
                            o.p._nvtd[1] = j),
                            o.p.navGrid = !0
                        }
        ...
        navSeparatorAdd: function(a, b) {
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    f && (e = $(f).val(),
                    e && ("first" === b.position ? $("#" + e).prepend(c) : $("#" + e).append(c))))
                }
            })
        },
        _buildNavMenu: function(a, b, c, d, e, f, g, h) {
            return this.each(function() {
                var i = this
                  , j = i.p.styleUI
                  , k = ($.jgrid.styleUI[j].navigator,
                $.jgrid.styleUI[j].filter)
                ...
                var o = {
                  ...
                  , p = function() {
                    var a, j, n = $(".ui-jqgrid-view").css("font-size") || "11px", p = $('<ul id="' + m + '" class="ui-nav-menu modal-content" role="menu" tabindex="0" style="display:none;font-size:' + n + '"></ul>');
                    c.add && (e = e || {},
                    a = e.id || "add_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function() {
                        return $(this).hasClass(l.disabled) || ($.isFunction(c.addfunc) ? c.addfunc.call(i) : $(i).jqGrid("editGridRow", "new", e),
                        $(p).hide()),
                        !1
                    }),
                    $(p).append(j)),
                    c.edit && (d = d || {},
                    a = d.id || "edit_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.edittext || c.edittitle) + "</a></li>").click(function() {
                    ...
                    c.view && (h = h || {},
                    a = h.id || "view_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.viewtext || c.viewtitle) + "</a></li>").click(function() {
                        if (!$(this).hasClass(l.disabled)) {
                            var a = i.p.selrow;
                    ...
                    c.del && (f = f || {},
                    a = f.id || "del_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.deltext || c.deltitle) + "</a></li>").click(function() {
                        if (!$(this).hasClass(l.disabled)) {
                            var a;
                    ...
                    c.search && (g = g || {},
                    a = g.id || "search_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.searchtext || c.searchtitle) + "</a></li>").click(function() {
                        return $(this).hasClass(l.disabled) || ($.isFunction(c.searchfunc) ? c.searchfunc.call(i, g) : $(i).jqGrid("searchGrid", g),
                        $(p).hide()),
                        !1
                    }),
                    $(p).append(j),
                    g.showOnLoad && g.showOnLoad === !0 && $(j).click()),
                    c.refresh && (a = g.id || "search_" + b,
                    j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.refreshtext || c.refreshtitle) + "</a></li>").click(function() {
                        if (!$(this).hasClass(l.disabled)) {
    ...
    $.jgrid.extend({
            ...
            return this.each(function() {
                ...
                f.groupField.length) {
                    ...
                    a = 0; a < f.groupField.length; a++)
                        ...
                        f.groupColumnShow[a] === !0 ? (f.visibiltyOnNextGrouping[a] = !0,
        ...
        groupingToggle: function(a) {
            return this.each(function() {
                ...
                var f, g, h = d.join("_"), i = c.minusicon, j = c.plusicon, k = $("#" + $.jgrid.jqID(a)), l = k.length ? k[0].nextSibling : null, m = $("#" + $.jgrid.jqID(a) + " span.tree-wrap-" + b.p.direction), n = function(a) {
                ...
                }, o = !1, p = !1, q = b.p.frozenColumns ? b.p.id + "_frozen" : !1, r = q ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(q)) : !1, s = r && r.length ? r[0].nextSibling : null;
                if (m.hasClass(i)) {
                    if (c.showSummaryOnHide) {
                        if (l)
                            for (; l && (f = n(l.className),
                            !(void 0 !== f && e >= f)); )
                                $(l).hide(),
                                l = l.nextSibling,
                                q && ($(s).hide(),
                    ...
                    if (l)
                        for (g = void 0; l; ) {
                            if (f = n(l.className),
                            void 0 === g && (g = void 0 === f),
                            p = $(l).hasClass("ui-subgrid") && $(l).hasClass("ui-sg-collapsed"),
                            void 0 !== f) {
                                if (e >= f)
                                    break;
                                f === e + 1 && (p || ($(l).show().find(">td>span.tree-wrap-" + b.p.direction).removeClass(i).addClass(j),
                                q && $(s).show().find(">td>span.tree-wrap-" + b.p.direction).removeClass(i).addClass(j)))
                            } else
                                g && (p || ($(l).show(),
                                q && $(s).show()));
                            l = l.nextSibling,
        ...
        groupingRender: function(a, b, c, d) {
            return this.each(function() {
                ...
                function f(a, c, d, f) {
                    var g, h, i = e(a, c, d), k = j.p.colModel, l = i.cnt, m = "";
                    for (h = f; b > h; h++) {
                ...
                $.each(k.groups, function(e, u) {
                    ...
                    try {
                        $.isArray(k.formatDisplayField) && $.isFunction(k.formatDisplayField[u.idx]) ? (u.displayValue = k.formatDisplayField[u.idx].call(j, u.displayValue, u.value, j.p.colModel[o[u.idx]], u.idx, k),
                        i = u.displayValue) : i = j.formatter(g, u.displayValue, o[u.idx], u.value)
                    } catch (v) {
                        i = u.displayValue
                    }
                    var w = "";
                    ...
                    "header" === k.groupSummaryPos[u.idx] ? (l += '<tr id="' + g + '"' + (k.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + q.content + " jqgroup ui-row-" + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * u.idx + 'px;"' + r + ">" + m + w + "</td>",
                    l += f(e, 0, k.groups, k.groupColumnShow[u.idx] === !1 ? "" === r ? 2 : 3 : "" === r ? 1 : 2),
                    l += "</tr>") : l += '<tr id="' + g + '"' + (k.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + q.content + " jqgroup ui-row-" + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * u.idx + 'px;" colspan="' + (k.groupColumnShow[u.idx] === !1 ? b - 1 : b) + '">' + m + w + "</td></tr>";
                    var x = p - 1 === u.idx;
                    if (x) {
                        var y, z, A = k.groups[e + 1], B = 0, C = u.startRow, D = void 0 !== A ? A.startRow : k.groups[e].startRow + k.groups[e].cnt;
                        for (k._locgr && (B = (c - 1) * d,
                        B > u.startRow && (C = B)),
                        y = C; D > y && a[y - B]; y++)
                            l += a[y - B].join("");
            ...
            this.each(function() {
                ...
                b = 0; s > b; b++)
                    ...
                    i >= 0) {
                        ...
                        0 === q ? a.useColSpanStyle ? g.attr("rowspan", "2") : ($("<th>", {
                            role: "columnheader"
                ...
                $(p).bind("jqGridResizeStop.setGroupHeaders", function(a, b, c) {
    ...
    $.extend($.jgrid, {
        saveState: function(a, b) {
            ...
            a) {
                ...
                if (g.grid) {
                    ...
                    $.isFunction(b.beforeSetItem) && (c = b.beforeSetItem.call(g, e),
                    null != c && (e = c)),
                    b.compression && b.compressionModule)
                        try {
        ...
        loadState: function(a, b, c) {
            ...
            a) {
                ...
                if (b) {
                    ...
                    if (d = jqGridUtils.parse(b),
                    d && "object" === $.type(d)) {
                        $.isFunction(c.beforeSetGrid) && (e = c.beforeSetGrid(d),
                        e && "object" === $.type(e) && (d = e));
                        var k = function(a) {
                            var b;
                            return b = a
                        ...
                        d.grouping = !1,
                        d.navGrid = !1,
                        d.inlineNav && (g = k(d._iN),
                        d._iN = null,
                        delete d._iN),
                        d.filterToolbar && (h = k(d._fT),
                        d._fT = null,
                        delete d._fT);
                        var m = $("#" + a).jqGrid(d);
                        m.append(f),
        ...
        setRegional: function(a, b) {
            ...
            $.each(d, function(a) {
                return this.formatter && "actions" === this.formatter ? (e = a,
                !1) : void 0
            }),
        ...
        jqGridExport: function(a) {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (d.rownumbers && (d.colNames.splice(0, 1),
                    d.colModel.splice(0, 1)),
                    d.multiselect && (d.colNames.splice(0, 1),
                    d.colModel.splice(0, 1)),
                    d.subGrid && (d.colNames.splice(0, 1),
                    d.colModel.splice(0, 1)),
                    d.knv = null,
                    d.treeGrid)
                        for (c in d.treeReader)
                            d.treeReader.hasOwnProperty(c) && (d.colNames.splice(d.colNames.length - 1),
                            d.colModel.splice(d.colModel.length - 1));
                    switch (a.exptype) {
                    case "xmlstring":
    ...
    $.jgrid.extend({
        editRow: function(a, b, c, d, e, f, g, h, i) {
            ...
            this.each(function() {
                var b, c, d, e, f, g, h = this, i = 0, k = null, l = {}, m = $(this).jqGrid("getStyleUI", h.p.styleUI + ".inlinedit", "inputClass", !0);
                h.grid && (e = $(h).jqGrid("getInd", a, !0),
                e !== !1 && (g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0,
                void 0 === g && (g = !0),
                g && (d = $(e).attr("editable") || "0",
                "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel,
                $('td[role="gridcell"]', e).each(function(d) {
                    ...
                    if ("cb" !== b && "subgrid" !== b && "rn" !== b && (h.p.autoencode && (c = $.jgrid.htmlDecode(c)),
                    l[b] = c,
                    f[d].editable === !0)) {
                        null === k && (k = d),
                ...
                h.p.savedRow.push(l),
                $(e).attr("editable", "1"),
                j.focusField && ("number" == typeof j.focusField && parseInt(j.focusField, 10) <= f.length && (k = j.focusField),
                setTimeout(function() {
                    var a = $("td:eq(" + k + ") :input:visible", e).not(":disabled");
                    a.length > 0 && a.focus()
                }, 0)),
                j.keys === !0 && $(e).bind("keyup", function(b) {
                    if (27 === b.keyCode) {
                        if ($(h).jqGrid("restoreRow", a, j.afterrestorefunc),
                        h.p.inlineNav)
                            try {
                    ...
                    if (13 === b.keyCode) {
                        var d = b.target;
                        if ("TEXTAREA" === d.tagName)
                            return !0;
                        if ($(h).jqGrid("saveRow", a, j) && h.p.inlineNav)
                            try {
                                $(h).jqGrid("showAddEditButtons")
                            } catch (e) {}
                        return !1
                ...
                $(h).triggerHandler("jqGridInlineEditRow", [a, j]),
                $.isFunction(j.oneditfunc) && j.oneditfunc.call(h, a))))))
            })
        },
            ...
            x) {
                ...
                "1" === l) {
                    ...
                    if ($('td[role="gridcell"]', o).each(function(a) {
                        if (y = j.p.colModel[a],
                        k = y.name,
                        "cb" !== k && "subgrid" !== k && y.editable === !0 && "rn" !== k && !$(this).hasClass("not-editable-cell")) {
                            switch (y.edittype) {
                            case "checkbox":
                                var b = ["Yes", "No"];
                            ...
                            "clientArray" !== i.url && y.editoptions && y.editoptions.NullIfEmpty === !0 && "" === q[k] && (s[k] = "null",
                            t = !0)
                        }
                    }),
                    n[0] === !1) {
                    ...
                    var C, D = j.p.prmNames, E = a;
                    if (C = j.p.keyName === !1 ? D.id : j.p.keyName,
                    q) {
                        if (q[D.oper] = D.editoper,
                        void 0 === q[C] || "" === q[C])
                            q[C] = a;
                        else if (o.id !== j.p.idPrefix + q[C]) {
                            var F = $.jgrid.stripPref(j.p.idPrefix, a);
                            if (void 0 !== j.p._index[F] && (j.p._index[q[C]] = j.p._index[F],
                            delete j.p._index[F]),
                            a = j.p.idPrefix + q[C],
                            $(o).attr("id", a),
                            j.p.selrow === E && (j.p.selrow = a),
        ...
        restoreRow: function(a, b) {
            ...
            this.each(function() {
                ...
                if (e.grid && (b = $(e).jqGrid("getInd", a, !0),
                b !== !1)) {
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    c)
                        ...
                        a.useDefValues === !0 && $(b.p.colModel).each(function() {
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    b.add && $(c).jqGrid("navButtonAdd", a, {
                        ...
                        onClickButton: function() {
                            ...
                            b.addParams.useFormatter || ($("#" + e + "_ilsave").removeClass(f),
                    ...
                    b.edit && $(c).jqGrid("navButtonAdd", a, {
                        ...
                        onClickButton: function() {
                            ...
                            a ? ($(c).jqGrid("editRow", a, b.editParams),
                            $("#" + e + "_ilsave").removeClass(f),
                            $("#" + e + "_ilcancel").removeClass(f),
                            $("#" + e + "_iladd").addClass(f),
                    ...
                    b.restoreAfterSelect === !0 && $(c).bind("jqGridBeforeSelectRow.inlineNav", function(a, d) {
                        c.p.savedRow.length > 0 && c.p.inlineNav === !0 && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : $(c).jqGrid("restoreRow", c.p.selrow, b.editParams),
                        $(c).jqGrid("showAddEditButtons"))
                    })
                }
            })
        },
        ...
        gridDnD: function(a) {
            return this.each(function() {
                ...
                if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    ...
                    if (void 0 === $("#jqgrid_dnd")[0] && $("body").append(f),
                    "string" == typeof a && "updateDnD" === a && e.p.jqgdnd === !0)
                        return void b();
                    if (a = $.extend({
                        drag: function(a) {
                            return $.extend({
                                ...
                                drop: function(b, c) {
                                    if ($(c.draggable).hasClass("jqgrow")) {
                                        ...
                                        if (!a.dropbyname) {
                                            ...
                                            try {
                                                for (h in f)
                                                    f.hasOwnProperty(h) && (g = k[i].name,
                                                    "cb" !== g && "rn" !== g && "subgrid" !== g && f.hasOwnProperty(h) && k[i] && (j[g] = f[h]),
                                                    i++);
                                                f = j
                                            } catch (l) {}
                                        }
                                        if (c.helper.dropped = !0,
                                        a.beforedrop && $.isFunction(a.beforedrop)) {
                                            var m = a.beforedrop.call(this, b, c, f, $("#" + $.jgrid.jqID(e.p.id)), $(this));
                                            void 0 !== m && null !== m && "object" == typeof m && (f = m)
                                        }
                                        if (c.helper.dropped) {
                                            var n;
                                            a.autoid && ($.isFunction(a.autoid) ? n = a.autoid.call(this, f) : (n = Math.ceil(1e3 * Math.random()),
                                            n = a.autoidprefix + n)),
    ...
    $.jgrid.extend({
        pivotSetup: function(a, b) {
            ...
            return this.each(function() {
                ...
                function m(a, b, c, d) {
                    var e, h, i, j, k = b.length, m = "", n = [];
                    for ($.isArray(c) ? (j = c.length,
                    n = c) : (j = 1,
                    n[0] = c),
                    f = [],
                    g = [],
                    ...
                    i = 0; j > i; i++) {
                        ...
                        for (e = 0; k > e; e++) {
                            if (null == c)
                                h = $.trim(b[e].member) + "_" + b[e].aggregator,
                                o = h,
                    ...
                    for (e in a)
                        if (a.hasOwnProperty(e)) {
                            if ("object" != typeof a[e]) {
                                if ("level" === e) {
                                    if (void 0 === J[a.level] && (J[a.level] = "",
                                    a.level > 0 && "_r_Totals" !== a.text && (i[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                                    })),
                            ...
                            "level" === e && a.level > 0 && a.level === (0 === s ? a.level : s)) {
                                d = 0;
                                for (b in a.fields)
                ...
                var o, p, q, r, s, t, u, v, w = a.length, x = 0;
                ...
                for (var A = r - 1, B = {}; w > x; ) {
                    ...
                    q = 0;
                    do
                        C[q] = $.trim(o[j.xDimension[q].dataName]),
                    ...
                    v = b(d, k, C)) {
                        if (p >= 0) {
                            ...
                            s >= 1) {
                                for (E = 0; s > E; E++)
                                    D[E] = $.trim(o[j.yDimension[E].dataName]),
                    ...
                    var F, G = 0, H = null, I = null;
                    for (F in f)
                        if (f.hasOwnProperty(F)) {
                            if (0 === G)
                                B.children && void 0 !== B.children || (B = {
                                    text: F,
                                    level: 0,
                                    children: [],
                                    label: F
        ...
        jqPivot: function(a, b, c, d) {
            return this.each(function() {
                function e(a) {
                    var d, e = jQuery(f).jqGrid("pivotSetup", a, b), g = $.assocArraySize(e.summary) > 0 ? !0 : !1, h = $.jgrid.from.call(f, e.rows);
                    for (d = 0; d < e.groupOptions.groupingView.groupField.length; d++)
                        h.orderBy(e.groupOptions.groupingView.groupField[d], "a", "text", "");
                    ...
                    if (i.length)
                        for (d = 0; d < i.length; d++)
                            i[d] && i[d].groupHeaders.length && jQuery(f).jqGrid("setGroupHeaders", i[d]);
        ...
        addSubGrid: function(a, b) {
            return this.each(function() {
                ...
                if (c.grid) {
                    ...
                    var p = c.rows.length
                      , q = 1;
                    for (void 0 !== b && b > 0 && (q = b,
                    p = b + 1); p > q; )
                        $(c.rows[q]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"),
                        $(c.rows[q].cells[a]).bind("click", function() {
                            ...
                            $(this).hasClass("sgcollapsed")) {
                                ...
                                g === !1)
                                    return !1;
                                c.p.subGridOptions.reloadOnExpand === !0 || c.p.subGridOptions.reloadOnExpand === !1 && !h.hasClass("ui-subgrid") ? (f = a >= 1 ? "<td colspan='" + a + "'>&#160;</td>" : "",
        ...
        toggleSubGridRow: function(a) {
            return this.each(function() {
                ...
                if ((b.grid || a) && b.p.subGrid === !0) {
                    ...
                    if (c) {
                        var d = $("td.sgcollapsed", c)[0];
                        d ? $(d).trigger("click") : (d = $("td.sgexpanded", c)[0],
                        d && $(d).trigger("click"))
                    }
                }
            })
    ...
    $.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid)
                    for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded, r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common; b > a; ) {
                        var s, t = $.jgrid.stripPref(c.p.idPrefix, c.rows[a].id), u = c.p._index[t];
                        j = c.p.data[u],
                        ...
                        "true" === j[n] || j[n] === !0 ? (i += (void 0 !== j[p] && "" !== j[p] ? j[p] : c.p.treeIcons.leaf) + " tree-leaf treeclick",
                        j[n] = !0,
                        k = "leaf") : (j[n] = !1,
                        k = ""),
                        ...
                        f !== parseInt(c.p.tree_root_level, 10) && (s = $(c).jqGrid("isVisibleNode", j),
                        s || $(c.rows[a]).css("display", "none")),
                        $(c.rows[a].cells[l]).find("div.treeclick").bind("click", function(a) {
                ...
                if (c.grid && c.p.treeGrid)
                    ...
                    case "nested":
                        ...
                        $(this.p.data).each(function() {
                            return parseInt(this[f], 10) === i - 1 && parseInt(this[d], 10) < g && parseInt(this[e], 10) > h ? (b = this,
                            !1) : void 0
                        });
                        break;
                    case "adjacency":
        ...
        getNodeAncestors: function(a) {
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid)
                    for (var c = $(this).jqGrid("getNodeParent", a); c; )
                        b.push(c),
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!a[b]) {
                        ...
                        if (k === !1)
                            return;
                        $(this).jqGrid("isNodeLoaded", this.p.data[j]) ? (a[b] = !0,
                        $("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (a[b] = !0,
                        $("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"),
        ...
        searchTree: function(a) {
            var b, c, d, e = a.length || 0, f = [], g = [], h = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && e)
                    for (c = this.p.localReader.id,
                    b = 0; e > b; b++)
                        f = $(this).jqGrid("getNodeAncestors", a[b]),
                        f.length || f.push(a[b]),
                        d = f[f.length - 1][c],
                        -1 === $.inArray(d, g) && (g.push(d),
                        f = $(this).jqGrid("getFullTreeNode", f[f.length - 1], !0),
                        h = h.concat(f))
            }),
            h
        },
        collectChildrenSortTree: function(a, b, c, d, e, f) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var g, h, i, j, k, l;
                    for (j = $(this).jqGrid("getNodeChildren", b),
    ...
    $.fn.jqm = function(a) {
        ...
        return this.each(function() {
            return this._jqm ? H[this._jqm].c = $.extend({}, H[this._jqm].c, a) : (s++,
            this._jqm = s,
            H[s] = {
    ...
    var s = 0
      ...
      , m = function(a) {
        ...
        return c && ($(".jqmID" + b.s).each(function() {
            var b = $(this)
              , d = b.offset();
            return d.top <= a.pageY && a.pageY <= d.top + b.height() && d.left <= a.pageX && a.pageX <= d.left + b.width() ? (c = !1,
            !1) : void 0
        }),
        f(b)),
        !c
    ...
    $.extend($.fmatter, {
        ...
        isEmpty: function(a) {
            return !this.isString(a) && this.isValue(a) ? !1 : this.isValue(a) ? (a = $.trim(a).replace(/\&nbsp\;/gi, "").replace(/\&#160\;/gi, ""),
            "" === a) : !0
        }
    }),
    ...
    $.fmatter.util = {
        NumberFormat: function(a, b) {
            ...
            $.fmatter.isNumber(a)) {
                var c, d = 0 > a, e = String(a), f = b.decimalSeparator || ".";
                if ($.fmatter.isNumber(b.decimalPlaces)) {
                    var g = b.decimalPlaces
                      , h = Math.pow(10, g);
                    if (e = String(Math.round(a * h) / h),
                    c = e.lastIndexOf("."),
                    g > 0)
                        for (0 > c ? (e += f,
    ...
    $.fn.fmatter.checkbox = function(a, b) {
        ...
        void 0 !== b.colModel && void 0 !== b.colModel.formatoptions && (d = $.extend({}, d, b.colModel.formatoptions)),
    ...
    $.fn.fmatter.select = function(a, b) {
        ...
        e) {
            var g, h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === !0) == !0 ? !0 : !1, i = [];
            if (h && (i = a.split(","),
            i = $.map(i, function(a) {
                return $.trim(a)
            })),
    ...
    $.fn.fmatter.rowactions = function(a) {
        ...
        case "edit":
            ...
            break;
        case "save":
            e.jqGrid("saveRow", c, m) && (i.find("div.ui-inline-edit,div.ui-inline-del").show(),
            i.find("div.ui-inline-save,div.ui-inline-cancel").hide(),
            e.triggerHandler("jqGridAfterGridComplete"));
            break;
        case "cancel":
    ...
    $.unformat.select = function(a, b, c, d) {
        ...
        if (g.value) {
            var j, k = g.value, l = g.multiple === !0 ? !0 : !1, m = [];
            if (l && (m = f.split(","),
            m = $.map(m, function(a) {
                return $.trim(a)
            })),
                    ...
                    if (7 !== a.nodeType) {
                        ...
                        if (a.attributes && a.attributes.length)
                            ...
                            d = 0; d < a.attributes.length; d++)
                                e = a.attributes[d].nodeName,
                                "string" == typeof e && (f = a.attributes[d].nodeValue,
                                f && (e = o.attr_prefix + e,
                                "undefined" == typeof g[e] && (g[e] = 0),
                                g[e]++,
                                addNode(c, e, g[e], f)));
                        if (a.childNodes && a.childNodes.length) {
                            var h = !0;
                            for (c && (h = !1),
                            d = 0; d < a.childNodes.length && h; d++) {
                            ...
                            if (h)
                                ...
                                for (c || (c = {}),
                                d = 0; d < a.childNodes.length; d++)
                                    e = a.childNodes[d].nodeName,
                                    "string" == typeof e && (f = parseElement(a.childNodes[d]),
                                    f && ("undefined" == typeof g[e] && (g[e] = 0),
                                    g[e]++,
                                    addNode(c, e, g[e], f)))
                        }
                        return c
